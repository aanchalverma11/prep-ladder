...
const ARTICLE_ITEMS = [
  {
    title: "Rapid Revision Reignite Dermatology: Question-Answ...",
    desc: "Bacterial Infections Of SkinBig Question 1: Describe bacterial skin infections and...",
    date: "Sep 12 2025",
    link: "#"
  },
  {
    title: "Compare & Recall: High-Yield Dermatology Tables for NEET PG",
    desc: "Table 1Lines in DermatologyBlaschko's LinesLanger's LinesTConstant, lines of...",
    date: "Jul 30 2025",
    link: "#"
  },
  {
    title: "20 High-Yield Dermatology Flashcards NEET PG 2026",
    desc: "Flashcard 1EpidermisCome Let's Get Sun Burnt: Stratum Corneum (come), Stratu...",
    date: "Jul 02 2025",
    link: "#"
  }
];
...
export default function Dermatology() {
  ...
  return (
    <div className="pl-dermatology-page">
      {/* Hero Section */}
      <section className="pl-dermatology-hero">
        <div className="pl-dermatology-container">
          <div className="pl-dermatology-hero__row">
            {/* Left Content */}
            <div className="pl-dermatology-hero__left">
              <span className="pl-dermatology-hero__tagline">
                Designed by our Dermatology Expert - Dr. Khushbu Mahajan
              </span>
              <h1 className="pl-dermatology-hero__heading">
                The Finest Dermatology <br />
                Online Course
              </h1>
              <p className="pl-dermatology-hero__description">
                A renowned Dermatology educator with more than 30 publications and 5 books to her credit.
              </p>
              
              <div className="pl-dermatology-hero__action">
                <Link to={`/courses/${courseSlug || "medical-pg"}/plan`} className="pl-dermatology-btn-enrol">
                  Enrol Now
                </Link>
              </div>

              {/* Stats Counters */}
              <div className="pl-dermatology-hero__stats">
                <div className="pl-dermatology-stat-item">
                  <div className="pl-dermatology-stat-icon pl-dermatology-stat-icon--green">
                  ...
                  <div className="pl-dermatology-stat-text">
                    <span className="pl-dermatology-stat-num">5M+</span>
                    <span className="pl-dermatology-stat-label">App Downloads</span>
                  </div>
                </div>

                <div className="pl-dermatology-stat-item">
                  <div className="pl-dermatology-stat-icon pl-dermatology-stat-icon--orange">
                  ...
                  <div className="pl-dermatology-stat-text">
                    <span className="pl-dermatology-stat-num">600M+</span>
                    <span className="pl-dermatology-stat-label">Hours Videos Watched</span>
                  </div>
                </div>

                <div className="pl-dermatology-stat-item">
                  <div className="pl-dermatology-stat-icon pl-dermatology-stat-icon--purple">
                  ...
                  <div className="pl-dermatology-stat-text">
                    <span className="pl-dermatology-stat-num">96%</span>
                    <span className="pl-dermatology-stat-label">NEET-PG 2023 Strike Rate</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Right Image */}
            <div className="pl-dermatology-hero__right">
              <div className="pl-dermatology-hero__image-wrapper">
                <img
                  src="https://image.prepladder.com/content/d66aybHxbztvO04bcwac1678097427.webp"
                  alt="Dr.Khushbu Mahajan"
                  className="pl-dermatology-hero__faculty-img"
                />
                <div className="pl-dermatology-hero__faculty-label">
                  <span>Dr.Khushbu Mahajan</span>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Features Section */}
      <section className="pl-dermatology-features">
        <div className="pl-dermatology-container">
          <div className="pl-dermatology-features__header">
            <h2 className="pl-dermatology-features__title">Let the Numbers Do the Talking</h2>
            <p className="pl-dermatology-features__subtitle">
              Get the best-in-class & comprehensive study material to boost your Dermatology and Venereology preparation.
            </p>
          </div>

          <div className="pl-dermatology-features__row">
            <div className="pl-dermatology-features__left">
              <div className="pl-dermatology-feature-card">
                <div className="pl-dermatology-feature-card__icon pl-dermatology-feature-card__icon--blue">
                ...
                <div className="pl-dermatology-feature-card__content">
                  <h3 className="pl-dermatology-feature-card__title">70+ Dermatology Video Lectures</h3>
                  <p className="pl-dermatology-feature-card__desc">High-yield video lectures for conceptual understanding.</p>
                </div>
              </div>

              <div className="pl-dermatology-feature-card">
                <div className="pl-dermatology-feature-card__icon pl-dermatology-feature-card__icon--green">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#10B981" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                    <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon>
                  </svg>
                </div>
                <div className="pl-dermatology-feature-card__content">
                  <h3 className="pl-dermatology-feature-card__title">30+ Dermatology Practice Questions</h3>
                  <p className="pl-dermatology-feature-card__desc">Questions for your continuous practice and evaluation.</p>
                </div>
              </div>

              <div className="pl-dermatology-feature-card">
                <div className="pl-dermatology-feature-card__icon pl-dermatology-feature-card__icon--orange">
                ...
                <div className="pl-dermatology-feature-card__content">
                  <h3 className="pl-dermatology-feature-card__title">80+ Dermatology Treasures</h3>
                  <p className="pl-dermatology-feature-card__desc">Easy-to-recall summaries in the form of flashcards.</p>
                </div>
              </div>

              <div className="pl-dermatology-feature-card">
                <div className="pl-dermatology-feature-card__icon pl-dermatology-feature-card__icon--purple">
                ...
                <div className="pl-dermatology-feature-card__content">
                  <h3 className="pl-dermatology-feature-card__title">330+ Dermatology Concept Pages</h3>
                  <p className="pl-dermatology-feature-card__desc">Video lectures take-aways.</p>
                </div>
              </div>
            </div>

            <div className="pl-dermatology-features__right">
              <div className="pl-dermatology-mockup-wrapper">
                <img src={d1} alt="PSM Features" className="pl-dermatology-mockup-img" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="pl-dermatology-dreamers">
        <div className="pl-dermatology-container">
          <h2 className="pl-dermatology-section-title pl-dermatology-section-title--centered">
            What Our Dreamers Say About Us
          </h2>
          <div className="pl-dermatology-dreamers__card">
            <div className="pl-dermatology-dreamers__row">
              {/* Left Column (Video/Thumbnail) */}
              <div className="pl-dermatology-dreamers__left">
                <div className="pl-dermatology-dreamer-video" onClick={() => setActiveVideo(DREAMER_DATA.videoUrl)}>
                  <img
                    src={DREAMER_DATA.poster}
                    alt={DREAMER_DATA.name}
                    className="pl-dermatology-dreamer-img"
                  />
                  <div className="pl-dermatology-dreamer-play-btn">
              ...
              {/* Right Column (Quote) */}
              <div className="pl-dermatology-dreamers__right">
                <div className="pl-dermatology-dreamer-quote-wrap">
                  <img src={DREAMER_DATA.quoteIcon} alt="Quote" className="pl-dermatology-dreamer-quote-icon" />
                  <p className="pl-dermatology-dreamer-quote-text">
                    {DREAMER_DATA.quote}
                  </p>
                  <div className="pl-dermatology-dreamer-author">
                    <span className="pl-dermatology-dreamer-author-name">{DREAMER_DATA.name}</span>
                    <span className="pl-dermatology-dreamer-author-rank">{DREAMER_DATA.rank}</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* Meet Our Toppers */}
      <section className="pl-dermatology-toppers">
        <div className="pl-dermatology-container">
          <h3 className="pl-dermatology-toppers-heading">
            Meet Our Toppers
          </h3>
          <div className="pl-dermatology-toppers__grid">
            {TOPPERS_LIST.map((topper, idx) => (
              <div key={idx} className="pl-dermatology-topper-card">
                <div className="pl-dermatology-topper-card__media" onClick={() => setActiveVideo(topper.videoUrl)}>
                  <img src={topper.poster} alt={topper.name} className="pl-dermatology-topper-poster" />
                  <div className="pl-dermatology-topper-play">
                    <img src={topper.playIcon} alt="Play" />
                  </div>
                </div>
                <div className="pl-dermatology-topper-card__info">
                  <h4 className="pl-dermatology-topper-name">{topper.name}</h4>
                  <p className="pl-dermatology-topper-rank-text">{topper.rank}</p>
                </div>
              </div>
            ))}
          </div>

          <div className="pl-dermatology-toppers__action">
            <a
              href="https://www.youtube.com/watch?v=bybs-n3XNZw&list=PLJY0wCIFC-Jjp92M_SPLMO5wNV_sX_M6d"
              target="_blank"
              rel="noopener noreferrer"
              className="pl-dermatology-toppers-more-link"
      ...
      <section className="pl-dermatology-other-subjects">
        <div className="pl-dermatology-container">
          <div className="pl-dermatology-other-subjects__header">
            <h2 className="pl-dermatology-other-subjects__title">Explore other NEET PG Subjects</h2>
            <p className="pl-dermatology-other-subjects__subtitle">Get the Best Study Material for all the 19 subjects</p>
          </div>

          <div className="pl-dermatology-other-subjects__grid">
            {OTHER_SUBJECTS.slice(0, showAllSubjects ? OTHER_SUBJECTS.length : 6).map((sub) => {
              const IconComp = SubjectIcons[sub.iconName];
              return (
                <Link to={sub.link} key={sub.id} className="pl-dermatology-subject-card">
                  <div className={`pl-dermatology-subject-card__icon-wrap ${sub.bgClass}`}>
                    <IconComp />
                  </div>
                  <div className="pl-dermatology-subject-card__content">
                    <h3 className="pl-dermatology-subject-card__name">{sub.name}</h3>
                    <p className="pl-dermatology-subject-card__desc">{sub.description}</p>
                  </div>
                </Link>
              );
            })}
          ...
          <div className="pl-dermatology-other-subjects__toggle">
            <button
              onClick={() => setShowAllSubjects(!showAllSubjects)}
              className="pl-dermatology-other-subjects__toggle-btn"
            >
      ...
      <section className="pl-dermatology-articles">
        <div className="pl-dermatology-container">
          <div className="pl-dermatology-articles__header">
            <h2 className="pl-dermatology-articles__title">Recent NEET PG Dermatology Articles</h2>
            <p className="pl-dermatology-articles__subtitle">Stay updated on everything related to NEET PG Dermatology preparation</p>
          </div>
          <div className="pl-dermatology-articles__grid">
            {ARTICLE_ITEMS.map((article, idx) => (
              <div key={idx} className="pl-dermatology-article-card">
                <h3 className="pl-dermatology-article-card__title">{article.title}</h3>
                <p className="pl-dermatology-article-card__desc">{article.desc}</p>
                <div className="pl-dermatology-article-card__footer">
                  <a href={article.link} className="pl-dermatology-article-card__readmore">Read More</a>
                  <span className="pl-dermatology-article-card__date">{article.date}</span>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="pl-dermatology-importance">
        <div className="pl-dermatology-container">
          <div className="pl-dermatology-importance__card">
            <h2 className="pl-dermatology-importance__title">Why is Dermatology important?</h2>
            <div className="pl-dermatology-importance__content">
              <p>
                Dermatology is a highly scoring and relatively concise subject for medical post-graduate exams. Having a strong foundation in dermatology and sexually transmitted infections is crucial for clinical diagnosis and exam preparation. {showMoreImportance ? (
                  <span>
                ...
                <button
                  ...
                  className="pl-dermatology-importance__readmore-btn"
                >
      ...
      {/* Video Overlay Modal */}
      {activeVideo && (
        <div className="pl-dermatology-video-modal" onClick={() => setActiveVideo(null)}>
          <div className="pl-dermatology-video-modal-content" onClick={(e) => e.stopPropagation()}>
            <button className="pl-dermatology-video-modal-close" onClick={() => setActiveVideo(null)}>×</button>
