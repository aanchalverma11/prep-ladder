...
export default function Orthopedics() {
  ...
  return (
    <div className="pl-orthopedics-page">
      {/* Hero Section */}
      <section className="pl-orthopedics-hero">
        <div className="pl-orthopedics-container">
          <div className="pl-orthopedics-hero__row">
            {/* Left Content */}
            <div className="pl-orthopedics-hero__left">
              <span className="pl-orthopedics-hero__tagline">
                Crafted by the Orthopedics guru - Dr. P.S.T. Jambukeswaran
              </span>
              <h1 className="pl-orthopedics-hero__heading">
                India's Best Orthopedics <br />
                Online Course
              </h1>
              <p className="pl-orthopedics-hero__description">
                He is currently serving as the Senior Assistant professor for the department of Orthopedics, GMC and ESI Hospital, Coimbatore, Tamil Nadu.
              </p>
              
              <div className="pl-orthopedics-hero__action">
                <Link to={`/courses/${courseSlug || "medical-pg"}/plan`} className="pl-orthopedics-btn-enrol">
                  Enrol Now
                </Link>
              </div>

              {/* Stats Counters */}
              <div className="pl-orthopedics-hero__stats">
                <div className="pl-orthopedics-stat-item">
                  <div className="pl-orthopedics-stat-icon pl-orthopedics-stat-icon--green">
                  ...
                  <div className="pl-orthopedics-stat-text">
                    <span className="pl-orthopedics-stat-num">5M+</span>
                    <span className="pl-orthopedics-stat-label">App Downloads</span>
                  </div>
                </div>

                <div className="pl-orthopedics-stat-item">
                  <div className="pl-orthopedics-stat-icon pl-orthopedics-stat-icon--orange">
                  ...
                  <div className="pl-orthopedics-stat-text">
                    <span className="pl-orthopedics-stat-num">600M+</span>
                    <span className="pl-orthopedics-stat-label">Hours Videos Watched</span>
                  </div>
                </div>

                <div className="pl-orthopedics-stat-item">
                  <div className="pl-orthopedics-stat-icon pl-orthopedics-stat-icon--purple">
                  ...
                  <div className="pl-orthopedics-stat-text">
                    <span className="pl-orthopedics-stat-num">96%</span>
                    <span className="pl-orthopedics-stat-label">NEET-PG 2023 Strike Rate</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Right Image */}
            <div className="pl-orthopedics-hero__right">
              <div className="pl-orthopedics-hero__image-wrapper">
                <img
                  src="https://image.prepladder.com/content/5xgCRfx0yF3VxZTx5kSx1744870944.png"
                  alt="Dr. Jambukeswaran"
                  className="pl-orthopedics-hero__faculty-img"
                />
                <div className="pl-orthopedics-hero__faculty-label">
                  <span>Dr. Jambukeswaran</span>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Features Section */}
      <section className="pl-orthopedics-features">
        <div className="pl-orthopedics-container">
          <div className="pl-orthopedics-features__header">
            <h2 className="pl-orthopedics-features__title">Let the Numbers Do the Talking</h2>
            <p className="pl-orthopedics-features__subtitle">
              Get the best-in-class & comprehensive study material to boost your Orthopedics preparation.
            </p>
          </div>

          <div className="pl-orthopedics-features__row">
            <div className="pl-orthopedics-features__left">
              <div className="pl-orthopedics-feature-card">
                <div className="pl-orthopedics-feature-card__icon pl-orthopedics-feature-card__icon--blue">
                ...
                <div className="pl-orthopedics-feature-card__content">
                  <h3 className="pl-orthopedics-feature-card__title">10+ Orthopedics Video Lectures</h3>
                  <p className="pl-orthopedics-feature-card__desc">High-yield video lectures for conceptual understanding.</p>
                </div>
              </div>

              <div className="pl-orthopedics-feature-card">
                <div className="pl-orthopedics-feature-card__icon pl-orthopedics-feature-card__icon--green">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#10B981" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                    <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon>
                  </svg>
                </div>
                <div className="pl-orthopedics-feature-card__content">
                  <h3 className="pl-orthopedics-feature-card__title">20+ Orthopedics Practice Questions</h3>
                  <p className="pl-orthopedics-feature-card__desc">Questions for your continuous practice and evaluation.</p>
                </div>
              </div>

              <div className="pl-orthopedics-feature-card">
                <div className="pl-orthopedics-feature-card__icon pl-orthopedics-feature-card__icon--orange">
                ...
                <div className="pl-orthopedics-feature-card__content">
                  <h3 className="pl-orthopedics-feature-card__title">110+ Orthopedics Treasures</h3>
                  <p className="pl-orthopedics-feature-card__desc">Easy-to-recall summaries in the form of flashcards.</p>
                </div>
              </div>

              <div className="pl-orthopedics-feature-card">
                <div className="pl-orthopedics-feature-card__icon pl-orthopedics-feature-card__icon--purple">
                ...
                <div className="pl-orthopedics-feature-card__content">
                  <h3 className="pl-orthopedics-feature-card__title">180+ Orthopedics Concept Pages</h3>
                  <p className="pl-orthopedics-feature-card__desc">Video lectures take-aways.</p>
                </div>
              </div>
            </div>

            <div className="pl-orthopedics-features__right">
              <div className="pl-orthopedics-mockup-wrapper">
                <img src={d1} alt="PSM Features" className="pl-orthopedics-mockup-img" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="pl-orthopedics-dreamers">
        <div className="pl-orthopedics-container">
          <h2 className="pl-orthopedics-section-title pl-orthopedics-section-title--centered">
            What Our Dreamers Say About Us
          </h2>
          <div className="pl-orthopedics-dreamers__card">
            <div className="pl-orthopedics-dreamers__row">
              {/* Left Column (Video/Thumbnail) */}
              <div className="pl-orthopedics-dreamers__left">
                <div className="pl-orthopedics-dreamer-video" onClick={() => setActiveVideo(DREAMER_DATA.videoUrl)}>
                  <img
                    src={DREAMER_DATA.poster}
                    alt={DREAMER_DATA.name}
                    className="pl-orthopedics-dreamer-img"
                  />
                  <div className="pl-orthopedics-dreamer-play-btn">
              ...
              {/* Right Column (Quote) */}
              <div className="pl-orthopedics-dreamers__right">
                <div className="pl-orthopedics-dreamer-quote-wrap">
                  <img src={DREAMER_DATA.quoteIcon} alt="Quote" className="pl-orthopedics-dreamer-quote-icon" />
                  <p className="pl-orthopedics-dreamer-quote-text">
                    {DREAMER_DATA.quote}
                  </p>
                  <div className="pl-orthopedics-dreamer-author">
                    <span className="pl-orthopedics-dreamer-author-name">{DREAMER_DATA.name}</span>
                    <span className="pl-orthopedics-dreamer-author-rank">{DREAMER_DATA.rank}</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* Meet Our Toppers */}
      <section className="pl-orthopedics-toppers">
        <div className="pl-orthopedics-container">
          <h3 className="pl-orthopedics-toppers-heading">
            Meet Our Toppers
          </h3>
          <div className="pl-orthopedics-toppers__grid">
            {TOPPERS_LIST.map((topper, idx) => (
              <div key={idx} className="pl-orthopedics-topper-card">
                <div className="pl-orthopedics-topper-card__media" onClick={() => setActiveVideo(topper.videoUrl)}>
                  <img src={topper.poster} alt={topper.name} className="pl-orthopedics-topper-poster" />
                  <div className="pl-orthopedics-topper-play">
                    <img src={topper.playIcon} alt="Play" />
                  </div>
                </div>
                <div className="pl-orthopedics-topper-card__info">
                  <h4 className="pl-orthopedics-topper-name">{topper.name}</h4>
                  <p className="pl-orthopedics-topper-rank-text">{topper.rank}</p>
                </div>
              </div>
            ))}
          </div>

          <div className="pl-orthopedics-toppers__action">
            <a
              href="https://www.youtube.com/watch?v=bybs-n3XNZw&list=PLJY0wCIFC-Jjp92M_SPLMO5wNV_sX_M6d"
              target="_blank"
              rel="noopener noreferrer"
              className="pl-orthopedics-toppers-more-link"
      ...
      <section className="pl-orthopedics-other-subjects">
        <div className="pl-orthopedics-container">
          <div className="pl-orthopedics-other-subjects__header">
            <h2 className="pl-orthopedics-other-subjects__title">Explore other NEET PG Subjects</h2>
            <p className="pl-orthopedics-other-subjects__subtitle">Get the Best Study Material for all the 19 subjects</p>
          </div>

          <div className="pl-orthopedics-other-subjects__grid">
            {OTHER_SUBJECTS.slice(0, showAllSubjects ? OTHER_SUBJECTS.length : 6).map((sub) => {
              const IconComp = SubjectIcons[sub.iconName];
              return (
                <Link to={sub.link} key={sub.id} className="pl-orthopedics-subject-card">
                  <div className={`pl-orthopedics-subject-card__icon-wrap ${sub.bgClass}`}>
                    <IconComp />
                  </div>
                  <div className="pl-orthopedics-subject-card__content">
                    <h3 className="pl-orthopedics-subject-card__name">{sub.name}</h3>
                    <p className="pl-orthopedics-subject-card__desc">{sub.description}</p>
                  </div>
                </Link>
              );
            })}
          ...
          <div className="pl-orthopedics-other-subjects__toggle">
            <button
              onClick={() => setShowAllSubjects(!showAllSubjects)}
              className="pl-orthopedics-other-subjects__toggle-btn"
            >
      ...
      <section className="pl-orthopedics-importance">
        <div className="pl-orthopedics-container">
          <div className="pl-orthopedics-importance__card">
            <h2 className="pl-orthopedics-importance__title">Why is Orthopedics important?</h2>
            <div className="pl-orthopedics-importance__content">
              <p>
                With effective time management and a well-thought-out preparation strategy students can score high marks in this subject. Orthopedics is considered one of the shorter subjects and usually has 5-8 mark {showMoreImportance ? (
                  <span>
                ...
                <button
                  ...
                  className="pl-orthopedics-importance__readmore-btn"
                >
      ...
      {/* Video Overlay Modal */}
      {activeVideo && (
        <div className="pl-orthopedics-video-modal" onClick={() => setActiveVideo(null)}>
          <div className="pl-orthopedics-video-modal-content" onClick={(e) => e.stopPropagation()}>
            <button className="pl-orthopedics-video-modal-close" onClick={() => setActiveVideo(null)}>×</button>
