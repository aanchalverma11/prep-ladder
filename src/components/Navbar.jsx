...
export default function Navbar({ currentCourse = "Medical PG" }) {
  ...
  const subjectsByProf = {
    ...
    2: [
      ...
      { name: "Pharmacology", icon: <PharmacologyIcon />, path: `/courses/${currentCourseSlug}` },
    ],
    3: [
      { name: "Forensic Medicine", icon: <ForensicMedicineIcon />, path: `/courses/${currentCourseSlug}/forensic-medicine-preparation` },
      { name: "PSM", icon: <PsmIcon />, path: `/courses/${currentCourseSlug}` },
      { name: "ENT", icon: <EntIcon />, path: "/courses/ent-residency" },
      { name: "Ophthalmology", icon: <OphthalmologyIcon />, path: `/courses/${currentCourseSlug}` },
    ],
    4: [
      { name: "Gynecology & Obstetrics", icon: <GynObsIcon />, path: "/courses/obs-gyn-residency" },
      { name: "Pediatrics", icon: <PediatricsIcon />, path: "/courses/ss-pediatrics" },
      { name: "Surgery", icon: <SurgeryIcon />, path: "/courses/ss-surgery" },
      ...
      { name: "Anaesthesia", icon: <AnaesthesiaIcon />, path: `/courses/${currentCourseSlug}` },
      { name: "Orthopedics", icon: <OrthopedicsIcon />, path: `/courses/${currentCourseSlug}` },
      { name: "Psychiatry", icon: <PsychiatryIcon />, path: "/courses/psychiatry-residency" },
      { name: "Dermatology", icon: <DermatologyIcon />, path: `/courses/${currentCourseSlug}` },
    ]
  };
