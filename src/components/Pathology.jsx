...
export default function Pathology() {
  ...
  return (
    <div className="pl-pathology-page">
      {/* Hero Section */}
      <section className="pl-pathology-hero">
        <div className="pl-pathology-container">
          <div className="pl-pathology-hero__row">
            {/* Left Content */}
            <div className="pl-pathology-hero__left">
              <span className="pl-pathology-hero__tagline">
                Crafted by the Patho Mage - Dr. Preeti Sharma
              </span>
              <h1 className="pl-pathology-hero__heading">
                India's Best Pathology <br />
                Online Course
              </h1>
              <p className="pl-pathology-hero__description">
                She is gold medal winner from the renowned Safdarjung Hospital for Pathology.
              </p>
              
              <div className="pl-pathology-hero__action">
                <Link to={`/courses/${courseSlug || "medical-pg"}/plan`} className="pl-pathology-btn-enrol">
                  Enrol Now
                </Link>
              </div>

              {/* Stats Counters */}
              <div className="pl-pathology-hero__stats">
                <div className="pl-pathology-stat-item">
                  <div className="pl-pathology-stat-icon pl-pathology-stat-icon--green">
                  ...
                  <div className="pl-pathology-stat-text">
                    <span className="pl-pathology-stat-num">5M+</span>
                    <span className="pl-pathology-stat-label">App Downloads</span>
                  </div>
                </div>

                <div className="pl-pathology-stat-item">
                  <div className="pl-pathology-stat-icon pl-pathology-stat-icon--orange">
                  ...
                  <div className="pl-pathology-stat-text">
                    <span className="pl-pathology-stat-num">600M+</span>
                    <span className="pl-pathology-stat-label">Hours Video Playback</span>
                  </div>
                </div>

                <div className="pl-pathology-stat-item">
                  <div className="pl-pathology-stat-icon pl-pathology-stat-icon--purple">
                  ...
                  <div className="pl-pathology-stat-text">
                    <span className="pl-pathology-stat-num">96%</span>
                    <span className="pl-pathology-stat-label">NEET PG 2023 strike rate</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Right Image */}
            <div className="pl-pathology-hero__right">
              <div className="pl-pathology-hero__image-wrapper">
                <img
                  src={docImage}
                  alt="Dr. Preeti Sharma"
                  className="pl-pathology-hero__faculty-img"
                />
                <div className="pl-pathology-hero__faculty-label">
                  <span>Dr.Preeti Sharma</span>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Features Section */}
      <section className="pl-pathology-features">
        <div className="pl-pathology-container">
          <div className="pl-pathology-features__header">
            <h2 className="pl-pathology-features__title">Let the Numbers Do the Talking</h2>
            <p className="pl-pathology-features__subtitle">
              Get the best-in-class & comprehensive study material to boost your Pathology preparation.
            </p>
          </div>

          <div className="pl-pathology-features__row">
            <div className="pl-pathology-features__left">
              <div className="pl-pathology-feature-card">
                <div className="pl-pathology-feature-card__icon pl-pathology-feature-card__icon--blue">
                ...
                <div className="pl-pathology-feature-card__content">
                  <h3 className="pl-pathology-feature-card__title">60+ Pathology Video Lectures</h3>
                  <p className="pl-pathology-feature-card__desc">High-yield video lectures for conceptual understanding.</p>
                </div>
              </div>

              <div className="pl-pathology-feature-card">
                <div className="pl-pathology-feature-card__icon pl-pathology-feature-card__icon--green">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#10B981" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                    <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon>
                  </svg>
                </div>
                <div className="pl-pathology-feature-card__content">
                  <h3 className="pl-pathology-feature-card__title">120+ Pathology Practice Questions</h3>
                  <p className="pl-pathology-feature-card__desc">Questions for your continuous practice and evaluation.</p>
                </div>
              </div>

              <div className="pl-pathology-feature-card">
                <div className="pl-pathology-feature-card__icon pl-pathology-feature-card__icon--orange">
                ...
                <div className="pl-pathology-feature-card__content">
                  <h3 className="pl-pathology-feature-card__title">120+ Pathology Treasures</h3>
                  <p className="pl-pathology-feature-card__desc">Easy-to-recall summaries in the form of flashcards.</p>
                </div>
              </div>

              <div className="pl-pathology-feature-card">
                <div className="pl-pathology-feature-card__icon pl-pathology-feature-card__icon--purple">
                ...
                <div className="pl-pathology-feature-card__content">
                  <h3 className="pl-pathology-feature-card__title">360+ Pathology Concept Pages</h3>
                  <p className="pl-pathology-feature-card__desc">Video lectures take-aways.</p>
                </div>
              </div>
            </div>

            <div className="pl-pathology-features__right">
              <div className="pl-pathology-mockup-wrapper">
                <img src={d1} alt="Pathology Features" className="pl-pathology-mockup-img" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="pl-pathology-dreamers">
        <div className="pl-pathology-container">
          <h2 className="pl-pathology-section-title pl-pathology-section-title--centered">
            What Our Dreamers Say About Us
          </h2>
          <div className="pl-pathology-dreamers__card">
            <div className="pl-pathology-dreamers__row">
              {/* Left Column (Video/Thumbnail) */}
              <div className="pl-pathology-dreamers__left">
                <div className="pl-pathology-dreamer-video" onClick={() => setActiveVideo(DREAMER_DATA.videoUrl)}>
                  <img
                    src={DREAMER_DATA.poster}
                    alt={DREAMER_DATA.name}
                    className="pl-pathology-dreamer-img"
                  />
                  <div className="pl-pathology-dreamer-play-btn">
              ...
              {/* Right Column (Quote) */}
              <div className="pl-pathology-dreamers__right">
                <div className="pl-pathology-dreamer-quote-wrap">
                  <img src={DREAMER_DATA.quoteIcon} alt="Quote" className="pl-pathology-dreamer-quote-icon" />
                  <p className="pl-pathology-dreamer-quote-text">
                    {DREAMER_DATA.quote}
                  </p>
                  <div className="pl-pathology-dreamer-author">
                    <span className="pl-pathology-dreamer-author-name">{DREAMER_DATA.name}</span>
                    <span className="pl-pathology-dreamer-author-rank">{DREAMER_DATA.rank}</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* Meet Our Toppers */}
      <section className="pl-pathology-toppers">
        <div className="pl-pathology-container">
          <h3 className="pl-pathology-toppers-heading">
            Meet Our Toppers
          </h3>
          <div className="pl-pathology-toppers__grid">
            {TOPPERS_LIST.map((topper, idx) => (
              <div key={idx} className="pl-pathology-topper-card">
                <div className="pl-pathology-topper-card__media" onClick={() => setActiveVideo(topper.videoUrl)}>
                  <img src={topper.poster} alt={topper.name} className="pl-pathology-topper-poster" />
                  <div className="pl-pathology-topper-play">
                    <img src={topper.playIcon} alt="Play" />
                  </div>
                </div>
                <div className="pl-pathology-topper-card__info">
                  <h4 className="pl-pathology-topper-name">{topper.name}</h4>
                  <p className="pl-pathology-topper-rank-text">{topper.rank}</p>
                </div>
              </div>
            ))}
          </div>

          <div className="pl-pathology-toppers__action">
            <a
              href="https://www.youtube.com/watch?v=bybs-n3XNZw&list=PLJY0wCIFC-Jjp92M_SPLMO5wNV_sX_M6d"
              target="_blank"
              rel="noopener noreferrer"
              className="pl-pathology-toppers-more-link"
      ...
      <section className="pl-pathology-other-subjects">
        <div className="pl-pathology-container">
          <div className="pl-pathology-other-subjects__header">
            <h2 className="pl-pathology-other-subjects__title">Explore other NEET PG Subjects</h2>
            <p className="pl-pathology-other-subjects__subtitle">Get the Best Study Material for all the 19 subjects</p>
          </div>

          <div className="pl-pathology-other-subjects__grid">
            {OTHER_SUBJECTS.slice(0, showAllSubjects ? OTHER_SUBJECTS.length : 6).map((sub) => {
              const IconComp = SubjectIcons[sub.iconName];
              return (
                <Link to={sub.link} key={sub.id} className="pl-pathology-subject-card">
                  <div className={`pl-pathology-subject-card__icon-wrap ${sub.bgClass}`}>
                    <IconComp />
                  </div>
                  <div className="pl-pathology-subject-card__content">
                    <h3 className="pl-pathology-subject-card__name">{sub.name}</h3>
                    <p className="pl-pathology-subject-card__desc">{sub.description}</p>
                  </div>
                </Link>
              );
            })}
          ...
          <div className="pl-pathology-other-subjects__toggle">
            <button
              onClick={() => setShowAllSubjects(!showAllSubjects)}
              className="pl-pathology-other-subjects__toggle-btn"
            >
      ...
      <section className="pl-pathology-importance">
        <div className="pl-pathology-container">
          <div className="pl-pathology-importance__card">
            <h2 className="pl-pathology-importance__title">Why is Pathology important?</h2>
            <div className="pl-pathology-importance__content">
              <p>
                Pathology is one such subject that is not only vast but is also one of the most important from the exam point of view. The subject demands time and regular revision as it makes a major portion of the NEET {showMoreImportance ? (
                  <span>
                    PG and other medical licensing exams. A strong foundation in Pathology is crucial for understanding clinical subjects like Medicine, Pediatrics, Anesthesia, and Pharmacology. By mastering the physiological systems, regulations, and compensatory mechanisms, aspirants can easily solve clinical scenario-based questions that are frequently asked in the exams.
                  </span>
                ) : null}
                <button
                  onClick={() => setShowMoreImportance(!showMoreImportance)}
                  className="pl-pathology-importance__readmore-btn"
                >
      ...
      {/* Video Overlay Modal */}
      {activeVideo && (
        <div className="pl-pathology-video-modal" onClick={() => setActiveVideo(null)}>
          <div className="pl-pathology-video-modal-content" onClick={(e) => e.stopPropagation()}>
            <button className="pl-pathology-video-modal-close" onClick={() => setActiveVideo(null)}>×</button>
