...
import "./ForensicMedicine.css";
import docImage from '../assets/spex.jpg';
...
export default function ForensicMedicine() {
  ...
  return (
    <div className="pl-forensic-page">
      {/* Hero Section */}
      <section className="pl-forensic-hero">
        <div className="pl-forensic-container">
          <div className="pl-forensic-hero__row">
            {/* Left Content */}
            <div className="pl-forensic-hero__left">
              <span className="pl-forensic-hero__tagline">
                Curated by our leading expert - Dr. Akhilesh Raj
              </span>
              <h1 className="pl-forensic-hero__heading">
                India's Best Forensic Medicine <br />
                Online Course
              </h1>
              <p className="pl-forensic-hero__description">
                He is the author of Review of Forensic Medicine and Toxicology for PGMEE.
              </p>
              
              <div className="pl-forensic-hero__action">
                <Link to={`/courses/${courseSlug || "medical-pg"}/plan`} className="pl-forensic-btn-enrol">
                  Enrol Now
                </Link>
              </div>

              {/* Stats Counters */}
              <div className="pl-forensic-hero__stats">
                <div className="pl-forensic-stat-item">
                  <div className="pl-forensic-stat-icon pl-forensic-stat-icon--green">
                  ...
                  <div className="pl-forensic-stat-text">
                    <span className="pl-forensic-stat-num">5M+</span>
                    <span className="pl-forensic-stat-label">App Downloads</span>
                  </div>
                </div>

                <div className="pl-forensic-stat-item">
                  <div className="pl-forensic-stat-icon pl-forensic-stat-icon--orange">
                  ...
                  <div className="pl-forensic-stat-text">
                    <span className="pl-forensic-stat-num">600M+</span>
                    <span className="pl-forensic-stat-label">Hours Video Playback</span>
                  </div>
                </div>

                <div className="pl-forensic-stat-item">
                  <div className="pl-forensic-stat-icon pl-forensic-stat-icon--purple">
                  ...
                  <div className="pl-forensic-stat-text">
                    <span className="pl-forensic-stat-num">96%</span>
                    <span className="pl-forensic-stat-label">NEET PG 2022 strike rate</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Right Image */}
            <div className="pl-forensic-hero__right">
              <div className="pl-forensic-hero__image-wrapper">
                <img
                  src={docImage}
                  alt="Dr. Akhilesh Raj"
                  className="pl-forensic-hero__faculty-img"
                />
                <div className="pl-forensic-hero__faculty-label">
                  <span>Dr.Akhilesh Raj</span>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Features Section */}
      <section className="pl-forensic-features">
        <div className="pl-forensic-container">
          <div className="pl-forensic-features__header">
            <h2 className="pl-forensic-features__title">Let the Numbers Do the Talking</h2>
            <p className="pl-forensic-features__subtitle">
              Get the best-in-class & comprehensive study material to boost your Forensic Medicine preparation.
            </p>
          </div>

          <div className="pl-forensic-features__row">
            <div className="pl-forensic-features__left">
              <div className="pl-forensic-feature-card">
                <div className="pl-forensic-feature-card__icon pl-forensic-feature-card__icon--blue">
                ...
                <div className="pl-forensic-feature-card__content">
                  <h3 className="pl-forensic-feature-card__title">90+ Forensic Medicine Video Lectures</h3>
                  <p className="pl-forensic-feature-card__desc">High-yield video lectures for conceptual understanding.</p>
                </div>
              </div>

              <div className="pl-forensic-feature-card">
                <div className="pl-forensic-feature-card__icon pl-forensic-feature-card__icon--green">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#10B981" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                    <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon>
                  </svg>
                </div>
                <div className="pl-forensic-feature-card__content">
                  <h3 className="pl-forensic-feature-card__title">30+ Forensic Medicine Practice Questions</h3>
                  <p className="pl-forensic-feature-card__desc">Questions for your continuous practice and evaluation.</p>
                </div>
              </div>

              <div className="pl-forensic-feature-card">
                <div className="pl-forensic-feature-card__icon pl-forensic-feature-card__icon--orange">
                ...
                <div className="pl-forensic-feature-card__content">
                  <h3 className="pl-forensic-feature-card__title">100+ Forensic Medicine Treasures</h3>
                  <p className="pl-forensic-feature-card__desc">Easy-to-recall summaries in the form of flashcards.</p>
                </div>
              </div>

              <div className="pl-forensic-feature-card">
                <div className="pl-forensic-feature-card__icon pl-forensic-feature-card__icon--purple">
                ...
                <div className="pl-forensic-feature-card__content">
                  <h3 className="pl-forensic-feature-card__title">340+ Forensic Medicine Concept Pages</h3>
                  <p className="pl-forensic-feature-card__desc">Video lectures take-aways.</p>
                </div>
              </div>
            </div>

            <div className="pl-forensic-features__right">
              <div className="pl-forensic-mockup-wrapper">
                <img src={d1} alt="ForensicMedicine Features" className="pl-forensic-mockup-img" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="pl-forensic-dreamers">
        <div className="pl-forensic-container">
          <h2 className="pl-forensic-section-title pl-forensic-section-title--centered">
            What Our Dreamers Say About Us
          </h2>
          <div className="pl-forensic-dreamers__card">
            <div className="pl-forensic-dreamers__row">
              {/* Left Column (Video/Thumbnail) */}
              <div className="pl-forensic-dreamers__left">
                <div className="pl-forensic-dreamer-video" onClick={() => setActiveVideo(DREAMER_DATA.videoUrl)}>
                  <img
                    src={DREAMER_DATA.poster}
                    alt={DREAMER_DATA.name}
                    className="pl-forensic-dreamer-img"
                  />
                  <div className="pl-forensic-dreamer-play-btn">
              ...
              {/* Right Column (Quote) */}
              <div className="pl-forensic-dreamers__right">
                <div className="pl-forensic-dreamer-quote-wrap">
                  <img src={DREAMER_DATA.quoteIcon} alt="Quote" className="pl-forensic-dreamer-quote-icon" />
                  <p className="pl-forensic-dreamer-quote-text">
                    {DREAMER_DATA.quote}
                  </p>
                  <div className="pl-forensic-dreamer-author">
                    <span className="pl-forensic-dreamer-author-name">{DREAMER_DATA.name}</span>
                    <span className="pl-forensic-dreamer-author-rank">{DREAMER_DATA.rank}</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* Meet Our Toppers */}
      <section className="pl-forensic-toppers">
        <div className="pl-forensic-container">
          <h3 className="pl-forensic-toppers-heading">
            Meet Our Toppers
          </h3>
          <div className="pl-forensic-toppers__grid">
            {TOPPERS_LIST.map((topper, idx) => (
              <div key={idx} className="pl-forensic-topper-card">
                <div className="pl-forensic-topper-card__media" onClick={() => setActiveVideo(topper.videoUrl)}>
                  <img src={topper.poster} alt={topper.name} className="pl-forensic-topper-poster" />
                  <div className="pl-forensic-topper-play">
                    <img src={topper.playIcon} alt="Play" />
                  </div>
                </div>
                <div className="pl-forensic-topper-card__info">
                  <h4 className="pl-forensic-topper-name">{topper.name}</h4>
                  <p className="pl-forensic-topper-rank-text">{topper.rank}</p>
                </div>
              </div>
            ))}
          </div>

          <div className="pl-forensic-toppers__action">
            <a
              href="https://www.youtube.com/watch?v=bybs-n3XNZw&list=PLJY0wCIFC-Jjp92M_SPLMO5wNV_sX_M6d"
              target="_blank"
              rel="noopener noreferrer"
              className="pl-forensic-toppers-more-link"
      ...
      <section className="pl-forensic-other-subjects">
        <div className="pl-forensic-container">
          <div className="pl-forensic-other-subjects__header">
            <h2 className="pl-forensic-other-subjects__title">Explore other NEET PG Subjects</h2>
            <p className="pl-forensic-other-subjects__subtitle">Get the Best Study Material for all the 19 subjects</p>
          </div>

          <div className="pl-forensic-other-subjects__grid">
            {OTHER_SUBJECTS.slice(0, showAllSubjects ? OTHER_SUBJECTS.length : 6).map((sub) => {
              const IconComp = SubjectIcons[sub.iconName];
              return (
                <Link to={sub.link} key={sub.id} className="pl-forensic-subject-card">
                  <div className={`pl-forensic-subject-card__icon-wrap ${sub.bgClass}`}>
                    <IconComp />
                  </div>
                  <div className="pl-forensic-subject-card__content">
                    <h3 className="pl-forensic-subject-card__name">{sub.name}</h3>
                    <p className="pl-forensic-subject-card__desc">{sub.description}</p>
                  </div>
                </Link>
              );
            })}
          ...
          <div className="pl-forensic-other-subjects__toggle">
            <button
              onClick={() => setShowAllSubjects(!showAllSubjects)}
              className="pl-forensic-other-subjects__toggle-btn"
            >
      ...
      {/* Why is ForensicMedicine important? */}
      <section className="pl-forensic-importance">
        <div className="pl-forensic-container">
          <div className="pl-forensic-importance__card">
            <h2 className="pl-forensic-importance__title">Why is Forensic Medicine important?</h2>
            <div className="pl-forensic-importance__content">
              <p>
                Forensic Medicine is one such subject that is not only vast but is also one of the most important from the exam point of view. The subject demands time and regular revision as it makes a major portion of the NEET {showMoreImportance ? (
                  <span>
                    PG and other medical licensing exams. A strong foundation in Forensic Medicine is crucial for understanding clinical subjects like Medicine, Pediatrics, Anesthesia, and Pharmacology. By mastering the physiological systems, regulations, and compensatory mechanisms, aspirants can easily solve clinical scenario-based questions that are frequently asked in the exams.
                  </span>
                ) : null}
                <button
                  onClick={() => setShowMoreImportance(!showMoreImportance)}
                  className="pl-forensic-importance__readmore-btn"
                >
      ...
      {/* Video Overlay Modal */}
      {activeVideo && (
        <div className="pl-forensic-video-modal" onClick={() => setActiveVideo(null)}>
          <div className="pl-forensic-video-modal-content" onClick={(e) => e.stopPropagation()}>
            <button className="pl-forensic-video-modal-close" onClick={() => setActiveVideo(null)}>×</button>
