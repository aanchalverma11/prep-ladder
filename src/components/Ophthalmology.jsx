...
export default function Ophthalmology() {
  ...
  return (
    <div className="pl-ophthalmology-page">
      {/* Hero Section */}
      <section className="pl-ophthalmology-hero">
        <div className="pl-ophthalmology-container">
          <div className="pl-ophthalmology-hero__row">
            {/* Left Content */}
            <div className="pl-ophthalmology-hero__left">
              <span className="pl-ophthalmology-hero__tagline">
                Created by India's leading specialist - Dr. Manish Chhabra
              </span>
              <h1 className="pl-ophthalmology-hero__heading">
                India's Best Ophthalmology <br />
                Online Course
              </h1>
              <p className="pl-ophthalmology-hero__description">
                He is the senior faculty for the Department of Ophthalmology at Delhi Academy of Medical Sciences (DAMS) .
              </p>
              
              <div className="pl-ophthalmology-hero__action">
                <Link to={`/courses/${courseSlug || "medical-pg"}/plan`} className="pl-ophthalmology-btn-enrol">
                  Enrol Now
                </Link>
              </div>

              {/* Stats Counters */}
              <div className="pl-ophthalmology-hero__stats">
                <div className="pl-ophthalmology-stat-item">
                  <div className="pl-ophthalmology-stat-icon pl-ophthalmology-stat-icon--green">
                  ...
                  <div className="pl-ophthalmology-stat-text">
                    <span className="pl-ophthalmology-stat-num">5M+</span>
                    <span className="pl-ophthalmology-stat-label">App Downloads</span>
                  </div>
                </div>

                <div className="pl-ophthalmology-stat-item">
                  <div className="pl-ophthalmology-stat-icon pl-ophthalmology-stat-icon--orange">
                  ...
                  <div className="pl-ophthalmology-stat-text">
                    <span className="pl-ophthalmology-stat-num">600M+</span>
                    <span className="pl-ophthalmology-stat-label">Hours Videos Watched</span>
                  </div>
                </div>

                <div className="pl-ophthalmology-stat-item">
                  <div className="pl-ophthalmology-stat-icon pl-ophthalmology-stat-icon--purple">
                  ...
                  <div className="pl-ophthalmology-stat-text">
                    <span className="pl-ophthalmology-stat-num">96%</span>
                    <span className="pl-ophthalmology-stat-label">NEET-PG 2023 Strike Rate</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Right Image */}
            <div className="pl-ophthalmology-hero__right">
              <div className="pl-ophthalmology-hero__image-wrapper">
                <img
                  src="https://image.prepladder.com/content/5VrIph9e3AF11cMZeY1L1775898663.png"
                  alt="Dr. Manish Chhabra"
                  className="pl-ophthalmology-hero__faculty-img"
                />
                <div className="pl-ophthalmology-hero__faculty-label">
                  <span>Dr. Manish Chhabra</span>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Features Section */}
      <section className="pl-ophthalmology-features">
        <div className="pl-ophthalmology-container">
          <div className="pl-ophthalmology-features__header">
            <h2 className="pl-ophthalmology-features__title">Let the Numbers Do the Talking</h2>
            <p className="pl-ophthalmology-features__subtitle">
              Get the best-in-class & comprehensive study material to boost your Ophthalmology preparation.
            </p>
          </div>

          <div className="pl-ophthalmology-features__row">
            <div className="pl-ophthalmology-features__left">
              <div className="pl-ophthalmology-feature-card">
                <div className="pl-ophthalmology-feature-card__icon pl-ophthalmology-feature-card__icon--blue">
                ...
                <div className="pl-ophthalmology-feature-card__content">
                  <h3 className="pl-ophthalmology-feature-card__title">60+ Ophthalmology Video Lectures</h3>
                  <p className="pl-ophthalmology-feature-card__desc">High-yield video lectures for conceptual understanding.</p>
                </div>
              </div>

              <div className="pl-ophthalmology-feature-card">
                <div className="pl-ophthalmology-feature-card__icon pl-ophthalmology-feature-card__icon--green">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#10B981" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                    <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon>
                  </svg>
                </div>
                <div className="pl-ophthalmology-feature-card__content">
                  <h3 className="pl-ophthalmology-feature-card__title">40+ Ophthalmology Practice Questions</h3>
                  <p className="pl-ophthalmology-feature-card__desc">Questions for your continuous practice and evaluation.</p>
                </div>
              </div>

              <div className="pl-ophthalmology-feature-card">
                <div className="pl-ophthalmology-feature-card__icon pl-ophthalmology-feature-card__icon--orange">
                ...
                <div className="pl-ophthalmology-feature-card__content">
                  <h3 className="pl-ophthalmology-feature-card__title">80+ Ophthalmology Treasures</h3>
                  <p className="pl-ophthalmology-feature-card__desc">Easy-to-recall summaries in the form of flashcards.</p>
                </div>
              </div>

              <div className="pl-ophthalmology-feature-card">
                <div className="pl-ophthalmology-feature-card__icon pl-ophthalmology-feature-card__icon--purple">
                ...
                <div className="pl-ophthalmology-feature-card__content">
                  <h3 className="pl-ophthalmology-feature-card__title">220+ Ophthalmology Concept Pages</h3>
                  <p className="pl-ophthalmology-feature-card__desc">Video lectures take-aways.</p>
                </div>
              </div>
            </div>

            <div className="pl-ophthalmology-features__right">
              <div className="pl-ophthalmology-mockup-wrapper">
                <img src={d1} alt="Ophthalmology Features" className="pl-ophthalmology-mockup-img" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="pl-ophthalmology-dreamers">
        <div className="pl-ophthalmology-container">
          <h2 className="pl-ophthalmology-section-title pl-ophthalmology-section-title--centered">
            What Our Dreamers Say About Us
          </h2>
          <div className="pl-ophthalmology-dreamers__card">
            <div className="pl-ophthalmology-dreamers__row">
              {/* Left Column (Video/Thumbnail) */}
              <div className="pl-ophthalmology-dreamers__left">
                <div className="pl-ophthalmology-dreamer-video" onClick={() => setActiveVideo(DREAMER_DATA.videoUrl)}>
                  <img
                    src={DREAMER_DATA.poster}
                    alt={DREAMER_DATA.name}
                    className="pl-ophthalmology-dreamer-img"
                  />
                  <div className="pl-ophthalmology-dreamer-play-btn">
              ...
              {/* Right Column (Quote) */}
              <div className="pl-ophthalmology-dreamers__right">
                <div className="pl-ophthalmology-dreamer-quote-wrap">
                  <img src={DREAMER_DATA.quoteIcon} alt="Quote" className="pl-ophthalmology-dreamer-quote-icon" />
                  <p className="pl-ophthalmology-dreamer-quote-text">
                    {DREAMER_DATA.quote}
                  </p>
                  <div className="pl-ophthalmology-dreamer-author">
                    <span className="pl-ophthalmology-dreamer-author-name">{DREAMER_DATA.name}</span>
                    <span className="pl-ophthalmology-dreamer-author-rank">{DREAMER_DATA.rank}</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* Meet Our Toppers */}
      <section className="pl-ophthalmology-toppers">
        <div className="pl-ophthalmology-container">
          <h3 className="pl-ophthalmology-toppers-heading">
            Meet Our Toppers
          </h3>
          <div className="pl-ophthalmology-toppers__grid">
            {TOPPERS_LIST.map((topper, idx) => (
              <div key={idx} className="pl-ophthalmology-topper-card">
                <div className="pl-ophthalmology-topper-card__media" onClick={() => setActiveVideo(topper.videoUrl)}>
                  <img src={topper.poster} alt={topper.name} className="pl-ophthalmology-topper-poster" />
                  <div className="pl-ophthalmology-topper-play">
                    <img src={topper.playIcon} alt="Play" />
                  </div>
                </div>
                <div className="pl-ophthalmology-topper-card__info">
                  <h4 className="pl-ophthalmology-topper-name">{topper.name}</h4>
                  <p className="pl-ophthalmology-topper-rank-text">{topper.rank}</p>
                </div>
              </div>
            ))}
          </div>

          <div className="pl-ophthalmology-toppers__action">
            <a
              href="https://www.youtube.com/watch?v=bybs-n3XNZw&list=PLJY0wCIFC-Jjp92M_SPLMO5wNV_sX_M6d"
              target="_blank"
              rel="noopener noreferrer"
              className="pl-ophthalmology-toppers-more-link"
      ...
      <section className="pl-ophthalmology-other-subjects">
        <div className="pl-ophthalmology-container">
          <div className="pl-ophthalmology-other-subjects__header">
            <h2 className="pl-ophthalmology-other-subjects__title">Explore other NEET PG Subjects</h2>
            <p className="pl-ophthalmology-other-subjects__subtitle">Get the Best Study Material for all the 19 subjects</p>
          </div>

          <div className="pl-ophthalmology-other-subjects__grid">
            {OTHER_SUBJECTS.slice(0, showAllSubjects ? OTHER_SUBJECTS.length : 6).map((sub) => {
              const IconComp = SubjectIcons[sub.iconName];
              return (
                <Link to={sub.link} key={sub.id} className="pl-ophthalmology-subject-card">
                  <div className={`pl-ophthalmology-subject-card__icon-wrap ${sub.bgClass}`}>
                    <IconComp />
                  </div>
                  <div className="pl-ophthalmology-subject-card__content">
                    <h3 className="pl-ophthalmology-subject-card__name">{sub.name}</h3>
                    <p className="pl-ophthalmology-subject-card__desc">{sub.description}</p>
                  </div>
                </Link>
              );
            })}
          ...
          <div className="pl-ophthalmology-other-subjects__toggle">
            <button
              onClick={() => setShowAllSubjects(!showAllSubjects)}
              className="pl-ophthalmology-other-subjects__toggle-btn"
            >
      ...
      <section className="pl-ophthalmology-importance">
        <div className="pl-ophthalmology-container">
          <div className="pl-ophthalmology-importance__card">
            <h2 className="pl-ophthalmology-importance__title">Why is Ophthalmology important?</h2>
            <div className="pl-ophthalmology-importance__content">
              <p>
                Ophthalmology is one such subject that is not only vast but is also one of the most important from the exam point of view. The subject demands time and regular revision as it makes a major portion of the NEET {showMoreImportance ? (
                  <span>
                ...
                <button
                  ...
                  className="pl-ophthalmology-importance__readmore-btn"
                >
      ...
      {/* Video Overlay Modal */}
      {activeVideo && (
        <div className="pl-ophthalmology-video-modal" onClick={() => setActiveVideo(null)}>
          <div className="pl-ophthalmology-video-modal-content" onClick={(e) => e.stopPropagation()}>
            <button className="pl-ophthalmology-video-modal-close" onClick={() => setActiveVideo(null)}>×</button>
