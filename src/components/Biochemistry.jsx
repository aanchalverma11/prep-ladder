...
import docImage from '../assets/DR.jpg';
...
export default function Biochemistry() {
  ...
  return (
    <div className="pl-Biochemistry-page">
      {/* Hero Section */}
      <section className="pl-Biochemistry-hero">
        <div className="pl-Biochemistry-container">
          <div className="pl-Biochemistry-hero__row">
            {/* Left Content */}
            <div className="pl-Biochemistry-hero__left">
              <span className="pl-Biochemistry-hero__tagline">
                Developed by our Biochemistry Expert — Dr. C. Shanmugapriya
              </span>
              <h1 className="pl-Biochemistry-hero__heading">
                Online Biochemistry Course for Assured NEET PG Success
              </h1>
              <p className="pl-Biochemistry-hero__description">
                A highly experienced and qualified Biochemistry expert who is adept at simplifying even the most complicated topics.
              </p>
              
              <div className="pl-Biochemistry-hero__action">
                <Link to={`/courses/${courseSlug || "medical-pg"}/plan`} className="pl-Biochemistry-btn-enrol">
                  Enrol Now
                </Link>
              </div>

              {/* Stats Counters */}
              <div className="pl-Biochemistry-hero__stats">
                <div className="pl-Biochemistry-stat-item">
                  <div className="pl-Biochemistry-stat-icon pl-Biochemistry-stat-icon--green">
                  ...
                  <div className="pl-Biochemistry-stat-text">
                    <span className="pl-Biochemistry-stat-num">5M+</span>
                    <span className="pl-Biochemistry-stat-label">App Downloads</span>
                  </div>
                </div>

                <div className="pl-Biochemistry-stat-item">
                  <div className="pl-Biochemistry-stat-icon pl-Biochemistry-stat-icon--orange">
                  ...
                  <div className="pl-Biochemistry-stat-text">
                    <span className="pl-Biochemistry-stat-num">600M+</span>
                    <span className="pl-Biochemistry-stat-label">Hours Videos Watched</span>
                  </div>
                </div>

                <div className="pl-Biochemistry-stat-item">
                  <div className="pl-Biochemistry-stat-icon pl-Biochemistry-stat-icon--purple">
                  ...
                  <div className="pl-Biochemistry-stat-text">
                    <span className="pl-Biochemistry-stat-num">96%</span>
                    <span className="pl-Biochemistry-stat-label">NEET-PG 2023 Strike Rate</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Right Image */}
            <div className="pl-Biochemistry-hero__right">
              <div className="pl-Biochemistry-hero__image-wrapper">
                <img
                  src={docImage}
                  alt="Dr. C. Shanmugapriya"
                  className="pl-Biochemistry-hero__faculty-img"
                />
                <div className="pl-Biochemistry-hero__faculty-label">
                  <span>Dr. C. Shanmugapriya</span>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Features Section */}
      <section className="pl-Biochemistry-features">
        <div className="pl-Biochemistry-container">
          <div className="pl-Biochemistry-features__header">
            <h2 className="pl-Biochemistry-features__title">Let the Numbers Do the Talking</h2>
            <p className="pl-Biochemistry-features__subtitle">
              Access the most comprehensive and well-structured online course for Biochemistry and elevate your exam preparation.
            </p>
          </div>

          <div className="pl-Biochemistry-features__row">
            <div className="pl-Biochemistry-features__left">
              <div className="pl-Biochemistry-feature-card">
                <div className="pl-Biochemistry-feature-card__icon pl-Biochemistry-feature-card__icon--blue">
                ...
                <div className="pl-Biochemistry-feature-card__content">
                  <h3 className="pl-Biochemistry-feature-card__title">160+ Biochemistry Video Lectures</h3>
                  <p className="pl-Biochemistry-feature-card__desc">High-yield video lectures for conceptual understanding.</p>
                </div>
              </div>

              <div className="pl-Biochemistry-feature-card">
                <div className="pl-Biochemistry-feature-card__icon pl-Biochemistry-feature-card__icon--green">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#10B981" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                    <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon>
                  </svg>
                </div>
                <div className="pl-Biochemistry-feature-card__content">
                  <h3 className="pl-Biochemistry-feature-card__title">40+ Biochemistry Practice Questions</h3>
                  <p className="pl-Biochemistry-feature-card__desc">Questions for your continuous practice and evaluation.</p>
                </div>
              </div>

              <div className="pl-Biochemistry-feature-card">
                <div className="pl-Biochemistry-feature-card__icon pl-Biochemistry-feature-card__icon--orange">
                ...
                <div className="pl-Biochemistry-feature-card__content">
                  <h3 className="pl-Biochemistry-feature-card__title">100+ Biochemistry Treasures</h3>
                  <p className="pl-Biochemistry-feature-card__desc">Easy-to-recall summaries in the form of flashcards.</p>
                </div>
              </div>

              <div className="pl-Biochemistry-feature-card">
                <div className="pl-Biochemistry-feature-card__icon pl-Biochemistry-feature-card__icon--purple">
                ...
                <div className="pl-Biochemistry-feature-card__content">
                  <h3 className="pl-Biochemistry-feature-card__title">290+ Biochemistry Concept Pages</h3>
                  <p className="pl-Biochemistry-feature-card__desc">Video lectures take-aways.</p>
                </div>
              </div>
            </div>

            <div className="pl-Biochemistry-features__right">
              <div className="pl-Biochemistry-mockup-wrapper">
                <img src={d1} alt="Biochemistry Features" className="pl-Biochemistry-mockup-img" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="pl-Biochemistry-dreamers">
        <div className="pl-Biochemistry-container">
          <h2 className="pl-Biochemistry-section-title pl-Biochemistry-section-title--centered">
            What Our Dreamers Say About Us
          </h2>
          <div className="pl-Biochemistry-dreamers__card">
            <div className="pl-Biochemistry-dreamers__row">
              {/* Left Column (Video/Thumbnail) */}
              <div className="pl-Biochemistry-dreamers__left">
                <div className="pl-Biochemistry-dreamer-video" onClick={() => setActiveVideo(DREAMER_DATA.videoUrl)}>
                  <img
                    src={DREAMER_DATA.poster}
                    alt={DREAMER_DATA.name}
                    className="pl-Biochemistry-dreamer-img"
                  />
                  <div className="pl-Biochemistry-dreamer-play-btn">
              ...
              {/* Right Column (Quote) */}
              <div className="pl-Biochemistry-dreamers__right">
                <div className="pl-Biochemistry-dreamer-quote-wrap">
                  <img src={DREAMER_DATA.quoteIcon} alt="Quote" className="pl-Biochemistry-dreamer-quote-icon" />
                  <p className="pl-Biochemistry-dreamer-quote-text">
                    {DREAMER_DATA.quote}
                  </p>
                  <div className="pl-Biochemistry-dreamer-author">
                    <span className="pl-Biochemistry-dreamer-author-name">{DREAMER_DATA.name}</span>
                    <span className="pl-Biochemistry-dreamer-author-rank">{DREAMER_DATA.rank}</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* Meet Our Toppers */}
      <section className="pl-Biochemistry-toppers">
        <div className="pl-Biochemistry-container">
          <h3 className="pl-Biochemistry-toppers-heading">
            Meet Our Toppers
          </h3>
          <div className="pl-Biochemistry-toppers__grid">
            {TOPPERS_LIST.map((topper, idx) => (
              <div key={idx} className="pl-Biochemistry-topper-card">
                <div className="pl-Biochemistry-topper-card__media" onClick={() => setActiveVideo(topper.videoUrl)}>
                  <img src={topper.poster} alt={topper.name} className="pl-Biochemistry-topper-poster" />
                  <div className="pl-Biochemistry-topper-play">
                    <img src={topper.playIcon} alt="Play" />
                  </div>
                </div>
                <div className="pl-Biochemistry-topper-card__info">
                  <h4 className="pl-Biochemistry-topper-name">{topper.name}</h4>
                  <p className="pl-Biochemistry-topper-rank-text">{topper.rank}</p>
                </div>
              </div>
            ))}
          </div>

          <div className="pl-Biochemistry-toppers__action">
            <a
              href="https://www.youtube.com/watch?v=bybs-n3XNZw&list=PLJY0wCIFC-Jjp92M_SPLMO5wNV_sX_M6d"
              target="_blank"
              rel="noopener noreferrer"
              className="pl-Biochemistry-toppers-more-link"
      ...
      <section className="pl-Biochemistry-other-subjects">
        <div className="pl-Biochemistry-container">
          <div className="pl-Biochemistry-other-subjects__header">
            <h2 className="pl-Biochemistry-other-subjects__title">Explore other NEET PG Subjects</h2>
            <p className="pl-Biochemistry-other-subjects__subtitle">Get the Best Study Material for all the 19 subjects</p>
          </div>

          <div className="pl-Biochemistry-other-subjects__grid">
            {OTHER_SUBJECTS.slice(0, showAllSubjects ? OTHER_SUBJECTS.length : 6).map((sub) => {
              const IconComp = SubjectIcons[sub.iconName];
              return (
                <Link to={sub.link} key={sub.id} className="pl-Biochemistry-subject-card">
                  <div className={`pl-Biochemistry-subject-card__icon-wrap ${sub.bgClass}`}>
                    <IconComp />
                  </div>
                  <div className="pl-Biochemistry-subject-card__content">
                    <h3 className="pl-Biochemistry-subject-card__name">{sub.name}</h3>
                    <p className="pl-Biochemistry-subject-card__desc">{sub.description}</p>
                  </div>
                </Link>
              );
            })}
          ...
          <div className="pl-Biochemistry-other-subjects__toggle">
            <button
              onClick={() => setShowAllSubjects(!showAllSubjects)}
              className="pl-Biochemistry-other-subjects__toggle-btn"
            >
      ...
      <section className="pl-Biochemistry-importance">
        <div className="pl-Biochemistry-container">
          <div className="pl-Biochemistry-importance__card">
            <h2 className="pl-Biochemistry-importance__title">Why is Biochemistry important?</h2>
            <div className="pl-Biochemistry-importance__content">
              <p>
                Biochemistry is one such subject that is not only vast but is also one of the most important from the exam point of view. The subject demands time and regular revision as it makes a major portion of the NEET {showMoreImportance ? (
                  <span>
                    PG and other medical licensing exams. A strong foundation in Biochemistry is crucial for understanding clinical subjects like Medicine, Pediatrics, Anesthesia, and Pharmacology. By mastering the physiological systems, regulations, and compensatory mechanisms, aspirants can easily solve clinical scenario-based questions that are frequently asked in the exams.
                  </span>
                ) : null}
                <button
                  onClick={() => setShowMoreImportance(!showMoreImportance)}
                  className="pl-Biochemistry-importance__readmore-btn"
                >
      ...
      {/* Video Overlay Modal */}
      {activeVideo && (
        <div className="pl-Biochemistry-video-modal" onClick={() => setActiveVideo(null)}>
          <div className="pl-Biochemistry-video-modal-content" onClick={(e) => e.stopPropagation()}>
            <button className="pl-Biochemistry-video-modal-close" onClick={() => setActiveVideo(null)}>×</button>
