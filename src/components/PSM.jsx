...
import "./PSM.css";
import docImage from '../assets/lady.jpg';
...
export default function PSM() {
  ...
  return (
    <div className="pl-psm-page">
      {/* Hero Section */}
      <section className="pl-psm-hero">
        <div className="pl-psm-container">
          <div className="pl-psm-hero__row">
            {/* Left Content */}
            <div className="pl-psm-hero__left">
              <span className="pl-psm-hero__tagline">
                Curated with India's foremost expert - Dr. Neha Taneja
              </span>
              <h1 className="pl-psm-hero__heading">
                India's Best PSM <br />
                Online Course
              </h1>
              <p className="pl-psm-hero__description">
                A highly qualified doctor and medical professional, she is a recipient of the Edward Kennedy Memorial Award for outstanding research work in Cancer Epidemiology.
              </p>
              
              <div className="pl-psm-hero__action">
                <a href="#plans" className="pl-psm-btn-enrol">
                  Enrol Now
                </a>
              </div>

              {/* Stats Counters */}
              <div className="pl-psm-hero__stats">
                <div className="pl-psm-stat-item">
                  <div className="pl-psm-stat-icon pl-psm-stat-icon--green">
                  ...
                  <div className="pl-psm-stat-text">
                    <span className="pl-psm-stat-num">5M+</span>
                    <span className="pl-psm-stat-label">App Downloads</span>
                  </div>
                </div>

                <div className="pl-psm-stat-item">
                  <div className="pl-psm-stat-icon pl-psm-stat-icon--orange">
                  ...
                  <div className="pl-psm-stat-text">
                    <span className="pl-psm-stat-num">600M+</span>
                    <span className="pl-psm-stat-label">Hours Video Playback</span>
                  </div>
                </div>

                <div className="pl-psm-stat-item">
                  <div className="pl-psm-stat-icon pl-psm-stat-icon--purple">
                  ...
                  <div className="pl-psm-stat-text">
                    <span className="pl-psm-stat-num">96%</span>
                    <span className="pl-psm-stat-label">NEET PG 2022 strike rate</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Right Image */}
            <div className="pl-psm-hero__right">
              <div className="pl-psm-hero__image-wrapper">
                <img
                  src={docImage}
                  alt="Dr. Neha Taneja"
                  className="pl-psm-hero__faculty-img"
                />
                <div className="pl-psm-hero__faculty-label">
                  <span>Dr. Neha Taneja</span>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Features Section */}
      <section className="pl-psm-features">
        <div className="pl-psm-container">
          <div className="pl-psm-features__header">
            <h2 className="pl-psm-features__title">Let the Numbers Do the Talking</h2>
            <p className="pl-psm-features__subtitle">
              Get the best-in-class & comprehensive study material to boost your PSM preparation.
            </p>
          </div>

          <div className="pl-psm-features__row">
            <div className="pl-psm-features__left">
              <div className="pl-psm-feature-card">
                <div className="pl-psm-feature-card__icon pl-psm-feature-card__icon--blue">
                ...
                <div className="pl-psm-feature-card__content">
                  <h3 className="pl-psm-feature-card__title">70+ PSM Video Lectures</h3>
                  <p className="pl-psm-feature-card__desc">High-yield video lectures for conceptual understanding.</p>
                </div>
              </div>

              <div className="pl-psm-feature-card">
                <div className="pl-psm-feature-card__icon pl-psm-feature-card__icon--green">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#10B981" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                    <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon>
                  </svg>
                </div>
                <div className="pl-psm-feature-card__content">
                  <h3 className="pl-psm-feature-card__title">80+ PSM Practice Questions</h3>
                  <p className="pl-psm-feature-card__desc">Questions for your continuous practice and evaluation.</p>
                </div>
              </div>

              <div className="pl-psm-feature-card">
                <div className="pl-psm-feature-card__icon pl-psm-feature-card__icon--orange">
                ...
                <div className="pl-psm-feature-card__content">
                  <h3 className="pl-psm-feature-card__title">70+ PSM Treasures</h3>
                  <p className="pl-psm-feature-card__desc">Easy-to-recall summaries in the form of flashcards.</p>
                </div>
              </div>

              <div className="pl-psm-feature-card">
                <div className="pl-psm-feature-card__icon pl-psm-feature-card__icon--purple">
                ...
                <div className="pl-psm-feature-card__content">
                  <h3 className="pl-psm-feature-card__title">340+ Forensic Medicine Concept Pages</h3>
                  <p className="pl-psm-feature-card__desc">Video lectures take-aways.</p>
                </div>
              </div>
            </div>

            <div className="pl-psm-features__right">
              <div className="pl-psm-mockup-wrapper">
                <img src={d1} alt="PSM Features" className="pl-psm-mockup-img" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="pl-psm-dreamers">
        <div className="pl-psm-container">
          <h2 className="pl-psm-section-title pl-psm-section-title--centered">
            What Our Dreamers Say About Us
          </h2>
          <div className="pl-psm-dreamers__card">
            <div className="pl-psm-dreamers__row">
              {/* Left Column (Video/Thumbnail) */}
              <div className="pl-psm-dreamers__left">
                <div className="pl-psm-dreamer-video" onClick={() => setActiveVideo(DREAMER_DATA.videoUrl)}>
                  <img
                    src={DREAMER_DATA.poster}
                    alt={DREAMER_DATA.name}
                    className="pl-psm-dreamer-img"
                  />
                  <div className="pl-psm-dreamer-play-btn">
              ...
              {/* Right Column (Quote) */}
              <div className="pl-psm-dreamers__right">
                <div className="pl-psm-dreamer-quote-wrap">
                  <img src={DREAMER_DATA.quoteIcon} alt="Quote" className="pl-psm-dreamer-quote-icon" />
                  <p className="pl-psm-dreamer-quote-text">
                    {DREAMER_DATA.quote}
                  </p>
                  <div className="pl-psm-dreamer-author">
                    <span className="pl-psm-dreamer-author-name">{DREAMER_DATA.name}</span>
                    <span className="pl-psm-dreamer-author-rank">{DREAMER_DATA.rank}</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* Meet Our Toppers */}
      <section className="pl-psm-toppers">
        <div className="pl-psm-container">
          <h3 className="pl-psm-toppers-heading">
            Meet Our Toppers
          </h3>
          <div className="pl-psm-toppers__grid">
            {TOPPERS_LIST.map((topper, idx) => (
              <div key={idx} className="pl-psm-topper-card">
                <div className="pl-psm-topper-card__media" onClick={() => setActiveVideo(topper.videoUrl)}>
                  <img src={topper.poster} alt={topper.name} className="pl-psm-topper-poster" />
                  <div className="pl-psm-topper-play">
                    <img src={topper.playIcon} alt="Play" />
                  </div>
                </div>
                <div className="pl-psm-topper-card__info">
                  <h4 className="pl-psm-topper-name">{topper.name}</h4>
                  <p className="pl-psm-topper-rank-text">{topper.rank}</p>
                </div>
              </div>
            ))}
          </div>

          <div className="pl-psm-toppers__action">
            <a
              href="https://www.youtube.com/watch?v=bybs-n3XNZw&list=PLJY0wCIFC-Jjp92M_SPLMO5wNV_sX_M6d"
              target="_blank"
              rel="noopener noreferrer"
              className="pl-psm-toppers-more-link"
      ...
      <section className="pl-psm-other-subjects">
        <div className="pl-psm-container">
          <div className="pl-psm-other-subjects__header">
            <h2 className="pl-psm-other-subjects__title">Explore other NEET PG Subjects</h2>
            <p className="pl-psm-other-subjects__subtitle">Get the Best Study Material for all the 19 subjects</p>
          </div>

          <div className="pl-psm-other-subjects__grid">
            {OTHER_SUBJECTS.slice(0, showAllSubjects ? OTHER_SUBJECTS.length : 6).map((sub) => {
              const IconComp = SubjectIcons[sub.iconName];
              return (
                <Link to={sub.link} key={sub.id} className="pl-psm-subject-card">
                  <div className={`pl-psm-subject-card__icon-wrap ${sub.bgClass}`}>
                    <IconComp />
                  </div>
                  <div className="pl-psm-subject-card__content">
                    <h3 className="pl-psm-subject-card__name">{sub.name}</h3>
                    <p className="pl-psm-subject-card__desc">{sub.description}</p>
                  </div>
                </Link>
              );
            })}
          ...
          <div className="pl-psm-other-subjects__toggle">
            <button
              onClick={() => setShowAllSubjects(!showAllSubjects)}
              className="pl-psm-other-subjects__toggle-btn"
            >
      ...
      <section className="pl-psm-importance">
        <div className="pl-psm-container">
          <div className="pl-psm-importance__card">
            <h2 className="pl-psm-importance__title">Why is Forensic Medicine important?</h2>
            <div className="pl-psm-importance__content">
              <p>
                ...
                <button
                  ...
                  className="pl-psm-importance__readmore-btn"
                >
      ...
      {/* Video Overlay Modal */}
      {activeVideo && (
        <div className="pl-psm-video-modal" onClick={() => setActiveVideo(null)}>
          <div className="pl-psm-video-modal-content" onClick={(e) => e.stopPropagation()}>
            <button className="pl-psm-video-modal-close" onClick={() => setActiveVideo(null)}>×</button>
