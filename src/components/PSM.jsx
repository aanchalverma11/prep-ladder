          ...
          <div className="pl-psm-hero__row">
            ...
            <div className="pl-psm-hero__left">
              ...
              <div className="pl-psm-hero__action">
                <Link to={`/courses/${courseSlug || "medical-pg"}/plan`} className="pl-psm-btn-enrol">
                  Enrol Now
                </Link>
              </div>
            ...
            <div className="pl-psm-hero__right">
              <div className="pl-psm-hero__image-wrapper">
                <img
                  src="https://image.prepladder.com/content/g0yvqOpT7zrmA1dnUCcI1744870956.png"
                  alt="Dr. Neha Taneja"
          ...
          <div className="pl-psm-features__row">
            <div className="pl-psm-features__left">
              ...
              <div className="pl-psm-feature-card">
                ...
                <div className="pl-psm-feature-card__content">
                  <h3 className="pl-psm-feature-card__title">340+ PSM Concept Pages</h3>
      ...
      <section className="pl-psm-importance">
        <div className="pl-psm-container">
          <div className="pl-psm-importance__card">
            <h2 className="pl-psm-importance__title">Why is PSM important?</h2>
            <div className="pl-psm-importance__content">
              <p>
                PSM is one such subject that is not only vast but is also one of the most important from the exam point of view. The subject demands time and regular revision as it makes a major portion of the NEET {showMoreImportance ? (
                  <span>
