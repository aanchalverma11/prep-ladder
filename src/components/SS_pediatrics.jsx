          ...
          <div className="row align-items-center">
            ...
            <div className="col-12 col-lg-6 ss-hero-text-col text-start">
              ...
              <div className="ss-hero-cta-wrapper">
                <Link to="/courses/ss-pediatrics/plan" className="ss-hero-enroll-btn" style={{ textDecoration: 'none', display: 'inline-flex', alignItems: 'center', justifyContent: 'center' }}>
                  Enrol Now
                </Link>
              </div>
            </div>
            ...
            <div className="row align-items-center">
              ...
              <div className="col-12 col-md-7 text-start ss-plan-details-col">
                ...
                <div className="ss-plan-cta-wrapper">
                  <Link to="/courses/ss-pediatrics/plan" className="ss-plan-enroll-large-btn" style={{ textDecoration: 'none', display: 'inline-flex', alignItems: 'center', justifyContent: 'center' }}>Enrol now</Link>
                </div>
              </div>
            </div>
          </div>
