            ...
            <div className="row align-items-center">
              ...
              <div className="col-12 col-md-7 text-start psych-plan-details-col">
                ...
                <div className="psych-plan-cta-wrapper">
                  <a href="/courses/psychiatry-residency/plan" className="psych-plan-enroll-large-btn" style={{ textDecoration: 'none', display: 'inline-flex', alignItems: 'center', justifyContent: 'center' }}>Enrol now</a>
                </div>
              </div>
            </div>
          </div>
