...
const ARTICLE_ITEMS = [
  {
    title: "High-Yield Anaesthesia Topics for NEET PG 2026: Important...",
    desc: "A 28-year-old male with ASA Grade I status is scheduled for emergency...",
    date: "Apr 16 2026",
    link: "#"
  },
  {
    title: "Rapid Revision Reignite Anesthesia: Question-Answer...",
    desc: "Supraglottic and Infraglottic Airway DevicesBig Question 1: What are...",
    date: "Sep 19 2025",
    link: "#"
  },
  {
    title: "Compare & Recall: High-Yield Anesthesia Tables for NEET PG",
    desc: "Table 1Regional AnesthesiaPeripheral nerve blockCentral neuraxial...",
    date: "Jul 16 2025",
    link: "#"
  }
];
...
export default function Anaesthesia() {
  ...
  return (
    <div className="pl-anaesthesia-page">
      {/* Hero Section */}
      <section className="pl-anaesthesia-hero">
        <div className="pl-anaesthesia-container">
          <div className="pl-anaesthesia-hero__row">
            {/* Left Content */}
            <div className="pl-anaesthesia-hero__left">
              <span className="pl-anaesthesia-hero__tagline">
                Crafted by India’s Leading Faculty - Dr. Mohammed Wajid Ali
              </span>
              <h1 className="pl-anaesthesia-hero__heading">
                India’s Best Anaesthesia <br />
                Online Course
              </h1>
              <p className="pl-anaesthesia-hero__description">
                Transforming the educational journey of anesthesia, Dr. Wajid Khan has helped countless aspirants achieve their dreams.
              </p>
              
              <div className="pl-anaesthesia-hero__action">
                <Link to={`/courses/${courseSlug || "medical-pg"}/plan`} className="pl-anaesthesia-btn-enrol">
                  Enrol Now
                </Link>
              </div>

              {/* Stats Counters */}
              <div className="pl-anaesthesia-hero__stats">
                <div className="pl-anaesthesia-stat-item">
                  <div className="pl-anaesthesia-stat-icon pl-anaesthesia-stat-icon--green">
                  ...
                  <div className="pl-anaesthesia-stat-text">
                    <span className="pl-anaesthesia-stat-num">5M+</span>
                    <span className="pl-anaesthesia-stat-label">App Downloads</span>
                  </div>
                </div>

                <div className="pl-anaesthesia-stat-item">
                  <div className="pl-anaesthesia-stat-icon pl-anaesthesia-stat-icon--orange">
                  ...
                  <div className="pl-anaesthesia-stat-text">
                    <span className="pl-anaesthesia-stat-num">600M+</span>
                    <span className="pl-anaesthesia-stat-label">Hours Videos Watched</span>
                  </div>
                </div>

                <div className="pl-anaesthesia-stat-item">
                  <div className="pl-anaesthesia-stat-icon pl-anaesthesia-stat-icon--purple">
                  ...
                  <div className="pl-anaesthesia-stat-text">
                    <span className="pl-anaesthesia-stat-num">96%</span>
                    <span className="pl-anaesthesia-stat-label">NEET-PG 2023 Strike Rate</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Right Image */}
            <div className="pl-anaesthesia-hero__right">
              <div className="pl-anaesthesia-hero__image-wrapper">
                <img
                  src="https://image.prepladder.com/content/UpkERpmR7Faa0pcwlFu91745218616.png"
                  alt="Dr. Mohammed Wajid Ali"
                  className="pl-anaesthesia-hero__faculty-img"
                />
                <div className="pl-anaesthesia-hero__faculty-label">
                  <span>Dr. Mohammed Wajid Ali</span>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Features Section */}
      <section className="pl-anaesthesia-features">
        <div className="pl-anaesthesia-container">
          <div className="pl-anaesthesia-features__header">
            <h2 className="pl-anaesthesia-features__title">Let the Numbers Do the Talking</h2>
            <p className="pl-anaesthesia-features__subtitle">
              Get the best-in-class & comprehensive study material to boost your Anaesthesia preparation.
            </p>
          </div>

          <div className="pl-anaesthesia-features__row">
            <div className="pl-anaesthesia-features__left">
              <div className="pl-anaesthesia-feature-card">
                <div className="pl-anaesthesia-feature-card__icon pl-anaesthesia-feature-card__icon--blue">
                ...
                <div className="pl-anaesthesia-feature-card__content">
                  <h3 className="pl-anaesthesia-feature-card__title">-5+ Anaesthesia Video Lectures</h3>
                  <p className="pl-anaesthesia-feature-card__desc">High-yield video lectures for conceptual understanding.</p>
                </div>
              </div>

              <div className="pl-anaesthesia-feature-card">
                <div className="pl-anaesthesia-feature-card__icon pl-anaesthesia-feature-card__icon--green">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#10B981" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                    <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon>
                  </svg>
                </div>
                <div className="pl-anaesthesia-feature-card__content">
                  <h3 className="pl-anaesthesia-feature-card__title">205+ Anaesthesia Practice Questions</h3>
                  <p className="pl-anaesthesia-feature-card__desc">Questions for your continuous practice and evaluation.</p>
                </div>
              </div>

              <div className="pl-anaesthesia-feature-card">
                <div className="pl-anaesthesia-feature-card__icon pl-anaesthesia-feature-card__icon--orange">
                ...
                <div className="pl-anaesthesia-feature-card__content">
                  <h3 className="pl-anaesthesia-feature-card__title">110+ Anaesthesia Treasures</h3>
                  <p className="pl-anaesthesia-feature-card__desc">Easy-to-recall summaries in the form of flashcards.</p>
                </div>
              </div>

              <div className="pl-anaesthesia-feature-card">
                <div className="pl-anaesthesia-feature-card__icon pl-anaesthesia-feature-card__icon--purple">
                ...
                <div className="pl-anaesthesia-feature-card__content">
                  <h3 className="pl-anaesthesia-feature-card__title">-5+ Anaesthesia Concept Pages</h3>
                  <p className="pl-anaesthesia-feature-card__desc">Video lectures take-aways.</p>
                </div>
              </div>
            </div>

            <div className="pl-anaesthesia-features__right">
              <div className="pl-anaesthesia-mockup-wrapper">
                <img src={d1} alt="PSM Features" className="pl-anaesthesia-mockup-img" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="pl-anaesthesia-dreamers">
        <div className="pl-anaesthesia-container">
          <h2 className="pl-anaesthesia-section-title pl-anaesthesia-section-title--centered">
            What Our Dreamers Say About Us
          </h2>
          <div className="pl-anaesthesia-dreamers__card">
            <div className="pl-anaesthesia-dreamers__row">
              {/* Left Column (Video/Thumbnail) */}
              <div className="pl-anaesthesia-dreamers__left">
                <div className="pl-anaesthesia-dreamer-video" onClick={() => setActiveVideo(DREAMER_DATA.videoUrl)}>
                  <img
                    src={DREAMER_DATA.poster}
                    alt={DREAMER_DATA.name}
                    className="pl-anaesthesia-dreamer-img"
                  />
                  <div className="pl-anaesthesia-dreamer-play-btn">
              ...
              {/* Right Column (Quote) */}
              <div className="pl-anaesthesia-dreamers__right">
                <div className="pl-anaesthesia-dreamer-quote-wrap">
                  <img src={DREAMER_DATA.quoteIcon} alt="Quote" className="pl-anaesthesia-dreamer-quote-icon" />
                  <p className="pl-anaesthesia-dreamer-quote-text">
                    {DREAMER_DATA.quote}
                  </p>
                  <div className="pl-anaesthesia-dreamer-author">
                    <span className="pl-anaesthesia-dreamer-author-name">{DREAMER_DATA.name}</span>
                    <span className="pl-anaesthesia-dreamer-author-rank">{DREAMER_DATA.rank}</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* Meet Our Toppers */}
      <section className="pl-anaesthesia-toppers">
        <div className="pl-anaesthesia-container">
          <h3 className="pl-anaesthesia-toppers-heading">
            Meet Our Toppers
          </h3>
          <div className="pl-anaesthesia-toppers__grid">
            {TOPPERS_LIST.map((topper, idx) => (
              <div key={idx} className="pl-anaesthesia-topper-card">
                <div className="pl-anaesthesia-topper-card__media" onClick={() => setActiveVideo(topper.videoUrl)}>
                  <img src={topper.poster} alt={topper.name} className="pl-anaesthesia-topper-poster" />
                  <div className="pl-anaesthesia-topper-play">
                    <img src={topper.playIcon} alt="Play" />
                  </div>
                </div>
                <div className="pl-anaesthesia-topper-card__info">
                  <h4 className="pl-anaesthesia-topper-name">{topper.name}</h4>
                  <p className="pl-anaesthesia-topper-rank-text">{topper.rank}</p>
                </div>
              </div>
            ))}
          </div>

          <div className="pl-anaesthesia-toppers__action">
            <a
              href="https://www.youtube.com/watch?v=bybs-n3XNZw&list=PLJY0wCIFC-Jjp92M_SPLMO5wNV_sX_M6d"
              target="_blank"
              rel="noopener noreferrer"
              className="pl-anaesthesia-toppers-more-link"
      ...
      <section className="pl-anaesthesia-other-subjects">
        <div className="pl-anaesthesia-container">
          <div className="pl-anaesthesia-other-subjects__header">
            <h2 className="pl-anaesthesia-other-subjects__title">Explore other NEET PG Subjects</h2>
            <p className="pl-anaesthesia-other-subjects__subtitle">Get the Best Study Material for all the 19 subjects</p>
          </div>

          <div className="pl-anaesthesia-other-subjects__grid">
            {OTHER_SUBJECTS.slice(0, showAllSubjects ? OTHER_SUBJECTS.length : 6).map((sub) => {
              const IconComp = SubjectIcons[sub.iconName];
              return (
                <Link to={sub.link} key={sub.id} className="pl-anaesthesia-subject-card">
                  <div className={`pl-anaesthesia-subject-card__icon-wrap ${sub.bgClass}`}>
                    <IconComp />
                  </div>
                  <div className="pl-anaesthesia-subject-card__content">
                    <h3 className="pl-anaesthesia-subject-card__name">{sub.name}</h3>
                    <p className="pl-anaesthesia-subject-card__desc">{sub.description}</p>
                  </div>
                </Link>
              );
            })}
          ...
          <div className="pl-anaesthesia-other-subjects__toggle">
            <button
              onClick={() => setShowAllSubjects(!showAllSubjects)}
              className="pl-anaesthesia-other-subjects__toggle-btn"
            >
      ...
      <section className="pl-anaesthesia-articles">
        <div className="pl-anaesthesia-container">
          <div className="pl-anaesthesia-articles__header">
            <h2 className="pl-anaesthesia-articles__title">Recent NEET PG Anaesthesia Articles</h2>
            <p className="pl-anaesthesia-articles__subtitle">Stay updated on everything related to NEET PG Anaesthesia preparation</p>
          </div>
          <div className="pl-anaesthesia-articles__grid">
            {ARTICLE_ITEMS.map((article, idx) => (
              <div key={idx} className="pl-anaesthesia-article-card">
                <h3 className="pl-anaesthesia-article-card__title">{article.title}</h3>
                <p className="pl-anaesthesia-article-card__desc">{article.desc}</p>
                <div className="pl-anaesthesia-article-card__footer">
                  <a href={article.link} className="pl-anaesthesia-article-card__readmore">Read More</a>
                  <span className="pl-anaesthesia-article-card__date">{article.date}</span>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="pl-anaesthesia-importance">
        <div className="pl-anaesthesia-container">
          <div className="pl-anaesthesia-importance__card">
            <h2 className="pl-anaesthesia-importance__title">Why is Anaesthesia important?</h2>
            <div className="pl-anaesthesia-importance__content">
              <p>
                Anaesthesia is one such subject that is not only vast but is also one of the most important from the exam point of view. The subject demands time and regular revision as it makes a major portion of the NEET {showMoreImportance ? (
                  <span>
                ...
                <button
                  ...
                  className="pl-anaesthesia-importance__readmore-btn"
                >
      ...
      {/* Video Overlay Modal */}
      {activeVideo && (
        <div className="pl-anaesthesia-video-modal" onClick={() => setActiveVideo(null)}>
          <div className="pl-anaesthesia-video-modal-content" onClick={(e) => e.stopPropagation()}>
            <button className="pl-anaesthesia-video-modal-close" onClick={() => setActiveVideo(null)}>×</button>
