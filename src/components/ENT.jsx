...
export default function ENT() {
  ...
  return (
    <div className="pl-ent-page">
      {/* Hero Section */}
      <section className="pl-ent-hero">
        <div className="pl-ent-container">
          <div className="pl-ent-hero__row">
            {/* Left Content */}
            <div className="pl-ent-hero__left">
              <span className="pl-ent-hero__tagline">
                Developed by India's leading specialist Dr. Vyshnavi Bommakanti
              </span>
              <h1 className="pl-ent-hero__heading">
                India's Best ENT <br />
                Online Course
              </h1>
              <p className="pl-ent-hero__description">
                She a full time ENT surgeon by profession, an educator by passion and researcher by heart.
              </p>
              
              <div className="pl-ent-hero__action">
                <Link to={`/courses/${courseSlug || "medical-pg"}/plan`} className="pl-ent-btn-enrol">
                  Enrol Now
                </Link>
              </div>

              {/* Stats Counters */}
              <div className="pl-ent-hero__stats">
                <div className="pl-ent-stat-item">
                  <div className="pl-ent-stat-icon pl-ent-stat-icon--green">
                  ...
                  <div className="pl-ent-stat-text">
                    <span className="pl-ent-stat-num">5M+</span>
                    <span className="pl-ent-stat-label">App Downloads</span>
                  </div>
                </div>

                <div className="pl-ent-stat-item">
                  <div className="pl-ent-stat-icon pl-ent-stat-icon--orange">
                  ...
                  <div className="pl-ent-stat-text">
                    <span className="pl-ent-stat-num">600M+</span>
                    <span className="pl-ent-stat-label">Hours Videos Watched</span>
                  </div>
                </div>

                <div className="pl-ent-stat-item">
                  <div className="pl-ent-stat-icon pl-ent-stat-icon--purple">
                  ...
                  <div className="pl-ent-stat-text">
                    <span className="pl-ent-stat-num">96%</span>
                    <span className="pl-ent-stat-label">NEET-PG 2023 Strike Rate</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Right Image */}
            <div className="pl-ent-hero__right">
              <div className="pl-ent-hero__image-wrapper">
                <img
                  src="https://image.prepladder.com/content/3UeWMAqScDIuH6Wi18301744870971.png"
                  alt="Dr. Vyshnavi Bommakanti"
                  className="pl-ent-hero__faculty-img"
                />
                <div className="pl-ent-hero__faculty-label">
                  <span>Dr. Vyshnavi Bommakanti</span>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Features Section */}
      <section className="pl-ent-features">
        <div className="pl-ent-container">
          <div className="pl-ent-features__header">
            <h2 className="pl-ent-features__title">Let the Numbers Do the Talking</h2>
            <p className="pl-ent-features__subtitle">
              Get the best-in-class & comprehensive study material to boost your ENT preparation.
            </p>
          </div>

          <div className="pl-ent-features__row">
            <div className="pl-ent-features__left">
              <div className="pl-ent-feature-card">
                <div className="pl-ent-feature-card__icon pl-ent-feature-card__icon--blue">
                ...
                <div className="pl-ent-feature-card__content">
                  <h3 className="pl-ent-feature-card__title">40+ ENT Video Lectures</h3>
                  <p className="pl-ent-feature-card__desc">High-yield video lectures for conceptual understanding.</p>
                </div>
              </div>

              <div className="pl-ent-feature-card">
                <div className="pl-ent-feature-card__icon pl-ent-feature-card__icon--green">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#10B981" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                    <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon>
                  </svg>
                </div>
                <div className="pl-ent-feature-card__content">
                  <h3 className="pl-ent-feature-card__title">30+ ENT Practice Questions</h3>
                  <p className="pl-ent-feature-card__desc">Questions for your continuous practice and evaluation.</p>
                </div>
              </div>

              <div className="pl-ent-feature-card">
                <div className="pl-ent-feature-card__icon pl-ent-feature-card__icon--orange">
                ...
                <div className="pl-ent-feature-card__content">
                  <h3 className="pl-ent-feature-card__title">70+ ENT Treasures</h3>
                  <p className="pl-ent-feature-card__desc">Easy-to-recall summaries in the form of flashcards.</p>
                </div>
              </div>

              <div className="pl-ent-feature-card">
                <div className="pl-ent-feature-card__icon pl-ent-feature-card__icon--purple">
                ...
                <div className="pl-ent-feature-card__content">
                  <h3 className="pl-ent-feature-card__title">220+ ENT Concept Pages</h3>
                  <p className="pl-ent-feature-card__desc">Video lectures take-aways.</p>
                </div>
              </div>
            </div>

            <div className="pl-ent-features__right">
              <div className="pl-ent-mockup-wrapper">
                <img src={d1} alt="PSM Features" className="pl-ent-mockup-img" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="pl-ent-dreamers">
        <div className="pl-ent-container">
          <h2 className="pl-ent-section-title pl-ent-section-title--centered">
            What Our Dreamers Say About Us
          </h2>
          <div className="pl-ent-dreamers__card">
            <div className="pl-ent-dreamers__row">
              {/* Left Column (Video/Thumbnail) */}
              <div className="pl-ent-dreamers__left">
                <div className="pl-ent-dreamer-video" onClick={() => setActiveVideo(DREAMER_DATA.videoUrl)}>
                  <img
                    src={DREAMER_DATA.poster}
                    alt={DREAMER_DATA.name}
                    className="pl-ent-dreamer-img"
                  />
                  <div className="pl-ent-dreamer-play-btn">
              ...
              {/* Right Column (Quote) */}
              <div className="pl-ent-dreamers__right">
                <div className="pl-ent-dreamer-quote-wrap">
                  <img src={DREAMER_DATA.quoteIcon} alt="Quote" className="pl-ent-dreamer-quote-icon" />
                  <p className="pl-ent-dreamer-quote-text">
                    {DREAMER_DATA.quote}
                  </p>
                  <div className="pl-ent-dreamer-author">
                    <span className="pl-ent-dreamer-author-name">{DREAMER_DATA.name}</span>
                    <span className="pl-ent-dreamer-author-rank">{DREAMER_DATA.rank}</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* Meet Our Toppers */}
      <section className="pl-ent-toppers">
        <div className="pl-ent-container">
          <h3 className="pl-ent-toppers-heading">
            Meet Our Toppers
          </h3>
          <div className="pl-ent-toppers__grid">
            {TOPPERS_LIST.map((topper, idx) => (
              <div key={idx} className="pl-ent-topper-card">
                <div className="pl-ent-topper-card__media" onClick={() => setActiveVideo(topper.videoUrl)}>
                  <img src={topper.poster} alt={topper.name} className="pl-ent-topper-poster" />
                  <div className="pl-ent-topper-play">
                    <img src={topper.playIcon} alt="Play" />
                  </div>
                </div>
                <div className="pl-ent-topper-card__info">
                  <h4 className="pl-ent-topper-name">{topper.name}</h4>
                  <p className="pl-ent-topper-rank-text">{topper.rank}</p>
                </div>
              </div>
            ))}
          </div>

          <div className="pl-ent-toppers__action">
            <a
              href="https://www.youtube.com/watch?v=bybs-n3XNZw&list=PLJY0wCIFC-Jjp92M_SPLMO5wNV_sX_M6d"
              target="_blank"
              rel="noopener noreferrer"
              className="pl-ent-toppers-more-link"
      ...
      <section className="pl-ent-other-subjects">
        <div className="pl-ent-container">
          <div className="pl-ent-other-subjects__header">
            <h2 className="pl-ent-other-subjects__title">Explore other NEET PG Subjects</h2>
            <p className="pl-ent-other-subjects__subtitle">Get the Best Study Material for all the 19 subjects</p>
          </div>

          <div className="pl-ent-other-subjects__grid">
            {OTHER_SUBJECTS.slice(0, showAllSubjects ? OTHER_SUBJECTS.length : 6).map((sub) => {
              const IconComp = SubjectIcons[sub.iconName];
              return (
                <Link to={sub.link} key={sub.id} className="pl-ent-subject-card">
                  <div className={`pl-ent-subject-card__icon-wrap ${sub.bgClass}`}>
                    <IconComp />
                  </div>
                  <div className="pl-ent-subject-card__content">
                    <h3 className="pl-ent-subject-card__name">{sub.name}</h3>
                    <p className="pl-ent-subject-card__desc">{sub.description}</p>
                  </div>
                </Link>
              );
            })}
          ...
          <div className="pl-ent-other-subjects__toggle">
            <button
              onClick={() => setShowAllSubjects(!showAllSubjects)}
              className="pl-ent-other-subjects__toggle-btn"
            >
      ...
      <section className="pl-ent-importance">
        <div className="pl-ent-container">
          <div className="pl-ent-importance__card">
            <h2 className="pl-ent-importance__title">Why is PSM important?</h2>
            <div className="pl-ent-importance__content">
              <p>
                ENT is one such subject that is not only vast but is also one of the most important from the exam point of view. The subject demands time and regular revision as it makes a major portion of the NEET {showMoreImportance ? (
                  <span>
                ...
                <button
                  ...
                  className="pl-ent-importance__readmore-btn"
                >
      ...
      {/* Video Overlay Modal */}
      {activeVideo && (
        <div className="pl-ent-video-modal" onClick={() => setActiveVideo(null)}>
          <div className="pl-ent-video-modal-content" onClick={(e) => e.stopPropagation()}>
            <button className="pl-ent-video-modal-close" onClick={() => setActiveVideo(null)}>×</button>
