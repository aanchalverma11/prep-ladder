...
const ARTICLE_ITEMS = [
  {
    title: "High-Yield Psychiatry Topics for NEET PG 2026: Key Disorders,...",
    desc: "A 28-year-old guy ends up in the ER after police found him wandering and talking ...",
    date: "Apr 07 2026",
    link: "#"
  },
  {
    title: "Nymphomania: Causes, Symptoms, Risk Factors,...",
    desc: "What is Nymphomania?Nymphomania is also referred to as hypersexuality,...",
    date: "Nov 24 2025",
    link: "#"
  },
  {
    title: "Compare & Recall: High-Yield Psychiatry Tables for NEET PG",
    desc: "Table 1Mood and AffectMoodAffectPersistent and...",
    date: "Aug 01 2025",
    link: "#"
  }
];
...
export default function Psychiatry() {
  ...
  return (
    <div className="pl-psychiatry-page">
      {/* Hero Section */}
      <section className="pl-psychiatry-hero">
        <div className="pl-psychiatry-container">
          <div className="pl-psychiatry-hero__row">
            {/* Left Content */}
            <div className="pl-psychiatry-hero__left">
              <span className="pl-psychiatry-hero__tagline">
                Designed by our Psychiatry Expert — Dr. Ankit Goel
              </span>
              <h1 className="pl-psychiatry-hero__heading">
                Effective Online Course on <br />
                Psychiatry
              </h1>
              <p className="pl-psychiatry-hero__description">
                A highly experienced and qualified Psychiatry expert who will make learning the subject easy and engaging.
              </p>
              
              <div className="pl-psychiatry-hero__action">
                <Link to={`/courses/${courseSlug || "medical-pg"}/plan`} className="pl-psychiatry-btn-enrol">
                  Enrol Now
                </Link>
              </div>

              {/* Stats Counters */}
              <div className="pl-psychiatry-hero__stats">
                <div className="pl-psychiatry-stat-item">
                  <div className="pl-psychiatry-stat-icon pl-psychiatry-stat-icon--green">
                  ...
                  <div className="pl-psychiatry-stat-text">
                    <span className="pl-psychiatry-stat-num">5M+</span>
                    <span className="pl-psychiatry-stat-label">App Downloads</span>
                  </div>
                </div>

                <div className="pl-psychiatry-stat-item">
                  <div className="pl-psychiatry-stat-icon pl-psychiatry-stat-icon--orange">
                  ...
                  <div className="pl-psychiatry-stat-text">
                    <span className="pl-psychiatry-stat-num">600M+</span>
                    <span className="pl-psychiatry-stat-label">Hours Videos Watched</span>
                  </div>
                </div>

                <div className="pl-psychiatry-stat-item">
                  <div className="pl-psychiatry-stat-icon pl-psychiatry-stat-icon--purple">
                  ...
                  <div className="pl-psychiatry-stat-text">
                    <span className="pl-psychiatry-stat-num">96%</span>
                    <span className="pl-psychiatry-stat-label">NEET-PG 2023 Strike Rate</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Right Image */}
            <div className="pl-psychiatry-hero__right">
              <div className="pl-psychiatry-hero__image-wrapper">
                <img
                  src="https://image.prepladder.com/content/Lru0sWbMPQFPhzlATuDq1744870932.png"
                  alt="Dr. Ankit Goel"
                  className="pl-psychiatry-hero__faculty-img"
                />
                <div className="pl-psychiatry-hero__faculty-label">
                  <span>Dr. Ankit Goel</span>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Features Section */}
      <section className="pl-psychiatry-features">
        <div className="pl-psychiatry-container">
          <div className="pl-psychiatry-features__header">
            <h2 className="pl-psychiatry-features__title">Let the Numbers Do the Talking</h2>
            <p className="pl-psychiatry-features__subtitle">
              Get the best-in-class & comprehensive study material to Access the most comprehensive and well-structured online course for Psychiatry and elevate your exam preparation.
            </p>
          </div>

          <div className="pl-psychiatry-features__row">
            <div className="pl-psychiatry-features__left">
              <div className="pl-psychiatry-feature-card">
                <div className="pl-psychiatry-feature-card__icon pl-psychiatry-feature-card__icon--blue">
                ...
                <div className="pl-psychiatry-feature-card__content">
                  <h3 className="pl-psychiatry-feature-card__title">10+ Psychiatry Video Lectures</h3>
                  <p className="pl-psychiatry-feature-card__desc">High-yield video lectures for conceptual understanding.</p>
                </div>
              </div>

              <div className="pl-psychiatry-feature-card">
                <div className="pl-psychiatry-feature-card__icon pl-psychiatry-feature-card__icon--green">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#10B981" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                    <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon>
                  </svg>
                </div>
                <div className="pl-psychiatry-feature-card__content">
                  <h3 className="pl-psychiatry-feature-card__title">20+ Psychiatry Practice Questions</h3>
                  <p className="pl-psychiatry-feature-card__desc">Questions for your continuous practice and evaluation.</p>
                </div>
              </div>

              <div className="pl-psychiatry-feature-card">
                <div className="pl-psychiatry-feature-card__icon pl-psychiatry-feature-card__icon--orange">
                ...
                <div className="pl-psychiatry-feature-card__content">
                  <h3 className="pl-psychiatry-feature-card__title">70+ Psychiatry Treasures</h3>
                  <p className="pl-psychiatry-feature-card__desc">Easy-to-recall summaries in the form of flashcards.</p>
                </div>
              </div>

              <div className="pl-psychiatry-feature-card">
                <div className="pl-psychiatry-feature-card__icon pl-psychiatry-feature-card__icon--purple">
                ...
                <div className="pl-psychiatry-feature-card__content">
                  <h3 className="pl-psychiatry-feature-card__title">130+ Psychiatry Concept Pages</h3>
                  <p className="pl-psychiatry-feature-card__desc">Video lectures take-aways.</p>
                </div>
              </div>
            </div>

            <div className="pl-psychiatry-features__right">
              <div className="pl-psychiatry-mockup-wrapper">
                <img src={d1} alt="PSM Features" className="pl-psychiatry-mockup-img" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="pl-psychiatry-dreamers">
        <div className="pl-psychiatry-container">
          <h2 className="pl-psychiatry-section-title pl-psychiatry-section-title--centered">
            What Our Dreamers Say About Us
          </h2>
          <div className="pl-psychiatry-dreamers__card">
            <div className="pl-psychiatry-dreamers__row">
              {/* Left Column (Video/Thumbnail) */}
              <div className="pl-psychiatry-dreamers__left">
                <div className="pl-psychiatry-dreamer-video" onClick={() => setActiveVideo(DREAMER_DATA.videoUrl)}>
                  <img
                    src={DREAMER_DATA.poster}
                    alt={DREAMER_DATA.name}
                    className="pl-psychiatry-dreamer-img"
                  />
                  <div className="pl-psychiatry-dreamer-play-btn">
              ...
              {/* Right Column (Quote) */}
              <div className="pl-psychiatry-dreamers__right">
                <div className="pl-psychiatry-dreamer-quote-wrap">
                  <img src={DREAMER_DATA.quoteIcon} alt="Quote" className="pl-psychiatry-dreamer-quote-icon" />
                  <p className="pl-psychiatry-dreamer-quote-text">
                    {DREAMER_DATA.quote}
                  </p>
                  <div className="pl-psychiatry-dreamer-author">
                    <span className="pl-psychiatry-dreamer-author-name">{DREAMER_DATA.name}</span>
                    <span className="pl-psychiatry-dreamer-author-rank">{DREAMER_DATA.rank}</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* Meet Our Toppers */}
      <section className="pl-psychiatry-toppers">
        <div className="pl-psychiatry-container">
          <h3 className="pl-psychiatry-toppers-heading">
            Meet Our Toppers
          </h3>
          <div className="pl-psychiatry-toppers__grid">
            {TOPPERS_LIST.map((topper, idx) => (
              <div key={idx} className="pl-psychiatry-topper-card">
                <div className="pl-psychiatry-topper-card__media" onClick={() => setActiveVideo(topper.videoUrl)}>
                  <img src={topper.poster} alt={topper.name} className="pl-psychiatry-topper-poster" />
                  <div className="pl-psychiatry-topper-play">
                    <img src={topper.playIcon} alt="Play" />
                  </div>
                </div>
                <div className="pl-psychiatry-topper-card__info">
                  <h4 className="pl-psychiatry-topper-name">{topper.name}</h4>
                  <p className="pl-psychiatry-topper-rank-text">{topper.rank}</p>
                </div>
              </div>
            ))}
          </div>

          <div className="pl-psychiatry-toppers__action">
            <a
              href="https://www.youtube.com/watch?v=bybs-n3XNZw&list=PLJY0wCIFC-Jjp92M_SPLMO5wNV_sX_M6d"
              target="_blank"
              rel="noopener noreferrer"
              className="pl-psychiatry-toppers-more-link"
      ...
      <section className="pl-psychiatry-other-subjects">
        <div className="pl-psychiatry-container">
          <div className="pl-psychiatry-other-subjects__header">
            <h2 className="pl-psychiatry-other-subjects__title">Explore other NEET PG Subjects</h2>
            <p className="pl-psychiatry-other-subjects__subtitle">Get the Best Study Material for all the 19 subjects</p>
          </div>

          <div className="pl-psychiatry-other-subjects__grid">
            {OTHER_SUBJECTS.slice(0, showAllSubjects ? OTHER_SUBJECTS.length : 6).map((sub) => {
              const IconComp = SubjectIcons[sub.iconName];
              return (
                <Link to={sub.link} key={sub.id} className="pl-psychiatry-subject-card">
                  <div className={`pl-psychiatry-subject-card__icon-wrap ${sub.bgClass}`}>
                    <IconComp />
                  </div>
                  <div className="pl-psychiatry-subject-card__content">
                    <h3 className="pl-psychiatry-subject-card__name">{sub.name}</h3>
                    <p className="pl-psychiatry-subject-card__desc">{sub.description}</p>
                  </div>
                </Link>
              );
            })}
          ...
          <div className="pl-psychiatry-other-subjects__toggle">
            <button
              onClick={() => setShowAllSubjects(!showAllSubjects)}
              className="pl-psychiatry-other-subjects__toggle-btn"
            >
      ...
      <section className="pl-psychiatry-articles">
        <div className="pl-psychiatry-container">
          <div className="pl-psychiatry-articles__header">
            <h2 className="pl-psychiatry-articles__title">Recent NEET PG Psychiatry Articles</h2>
            <p className="pl-psychiatry-articles__subtitle">Stay updated on everything related to NEET PG Psychiatry preparation</p>
          </div>
          <div className="pl-psychiatry-articles__grid">
            {ARTICLE_ITEMS.map((article, idx) => (
              <div key={idx} className="pl-psychiatry-article-card">
                <h3 className="pl-psychiatry-article-card__title">{article.title}</h3>
                <p className="pl-psychiatry-article-card__desc">{article.desc}</p>
                <div className="pl-psychiatry-article-card__footer">
                  <a href={article.link} className="pl-psychiatry-article-card__readmore">Read More</a>
                  <span className="pl-psychiatry-article-card__date">{article.date}</span>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="pl-psychiatry-importance">
        <div className="pl-psychiatry-container">
          <div className="pl-psychiatry-importance__card">
            <h2 className="pl-psychiatry-importance__title">Why is Psychiatry important?</h2>
            <div className="pl-psychiatry-importance__content">
              <p>
                Psychiatry is an essential subject for medical entrance exams like NEET PG and INI-CET. Understanding key psychiatric disorders, psychopharmacology, and diagnostic criteria is vital for scoring high in this clinical subject. {showMoreImportance ? (
                  <span>
                ...
                <button
                  ...
                  className="pl-psychiatry-importance__readmore-btn"
                >
      ...
      {/* Video Overlay Modal */}
      {activeVideo && (
        <div className="pl-psychiatry-video-modal" onClick={() => setActiveVideo(null)}>
          <div className="pl-psychiatry-video-modal-content" onClick={(e) => e.stopPropagation()}>
            <button className="pl-psychiatry-video-modal-close" onClick={() => setActiveVideo(null)}>×</button>
